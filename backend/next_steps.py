...
OFFICIAL_TERMIN_URLS: Dict[str, str] = {
    ...
    "munich": "https://stadt.muenchen.de/terminvereinbarung/",
    "hamburg": "https://www.hamburg.de/terminvereinbarung/",
    "frankfurt": "https://frankfurt.de/service-und-rathaus/terminvereinbarung",
    "cologne": "https://www.stadt-koeln.de/service/onlinedienste/kundenzentren/",
    "dusseldorf": "https://termine.duesseldorf.de/",
    "stuttgart": "https://www.stuttgart.de/buergerservice/",
    "default": "https://www.google.com/search?q=Bürgeramt+Termin+online",
}
...
def get_termin_url(city: Optional[str] = None) -> str:
    """Get official appointment booking URL for city."""
    if city:
        city_key = city.strip().lower()
        if city_key in OFFICIAL_TERMIN_URLS:
            return OFFICIAL_TERMIN_URLS[city_key]
    return OFFICIAL_TERMIN_URLS.get("default", "")
