...
def seed_berlin_data():
    ...
    if not city_exists:
        ...
        # ── Authorities — only supported checker types ──
        authorities = [
            ('buergeramt', 'Bürgeramt', 'Citizens Office', 'Бюргерамт', 'Urząd Obywatelski', 'Vatandaşlık Ofisi', 'مكتب المواطنين',
             'https://service.berlin.de/terminvereinbarung/', 'berlin_service'),
...
_NEW_CITIES = {
    'muenchen': {
        ...
        'authorities': [
            ('buergeramt', 'Bürgerbüro', 'Citizens Office', 'Бюргербюро', 'Biuro Obywatelskie', 'Vatandaşlık Ofisi', 'مكتب المواطنين', 'https://www.muenchen.de/rathaus/terminvereinbarung_buergerbuero.html', 'muenchen_kvr'),
            ('auslaenderbehoerde', 'Ausländerbehörde (KVR)', 'Immigration Office (KVR)', 'Міграційна служба (KVR)', 'Urząd ds. Cudzoziemców (KVR)', 'Yabancılar Dairesi (KVR)', 'مكتب شؤون الأجانب (KVR)', 'https://www.muenchen.de/rathaus/kreisverwaltungsreferat/auslaender-und-staatsangehoerigkeitsbehoerde/terminvereinbarung.html', 'muenchen_kvr'),
        ],
    ...
    'frankfurt': {
        ...
        'authorities': [
            ('buergeramt', 'Bürgerbüro Frankfurt', 'Citizens Office Frankfurt', 'Бюргербюро Франкфурт', 'Biuro Obywatelskie Frankfurt', 'Vatandaşlık Ofisi Frankfurt', 'مكتب المواطنين فرانكفورت', 'https://frankfurt.de/themen/buergerservice/buergerbuero', 'frankfurt_service'),
            ('auslaenderbehoerde', 'Ausländerbehörde Frankfurt', 'Immigration Office Frankfurt', 'Міграційна служба Франкфурт', 'Urząd ds. Cudzoziemców Frankfurt', 'Yabancılar Dairesi Frankfurt', 'مكتب شؤون الأجانب فرانكفورت', 'https://frankfurt.de/themen/buergerservice/auslaenderbehoerde', 'frankfurt_service'),
        ],
    ...
    'koeln': {
        ...
        'authorities': [
            ('buergeramt', 'Bürgerbüro Köln', 'Citizens Office Cologne', 'Бюргербюро Кельн', 'Biuro Obywatelskie Kolonia', 'Vatandaşlık Ofisi Köln', 'مكتب المواطنين كولونيا', 'https://www.stadt-koeln.de/buergerangelegenheiten/buergerbuero', 'koeln_service'),
            ('auslaenderbehoerde', 'Ausländerbehörde Köln', 'Immigration Office Cologne', 'Міграційна служба Кельн', 'Urząd ds. Cudzoziemców Kolonia', 'Yabancılar Dairesi Köln', 'مكتب شؤون الأجانب كولونيا', 'https://www.stadt-koeln.de/buergerangelegenheiten/zuwanderung-aufenthalt', 'koeln_service'),
        ],
    ...
    'duesseldorf': {
        ...
        'authorities': [
            ...
            ('auslaenderbehoerde', 'Ausländerbehörde Düsseldorf', 'Immigration Office Düsseldorf', 'Міграційна служба Дюссельдорф', 'Urząd ds. Cudzoziemców Düsseldorf', 'Yabancılar Dairesi Düsseldorf', 'مكتب شؤون الأجانب دوسلدورف', 'https://www2.duesseldorf.de/auslaenderamt/', 'duesseldorf_tevis'),
        ],
    ...
    'dortmund': {
        ...
        'authorities': [
            ('buergeramt', 'Stadtbüro Dortmund', 'Citizens Office Dortmund', 'Міський офіс Дортмунд', 'Urząd Miejski Dortmund', 'Vatandaşlık Ofisi Dortmund', 'مكتب المواطنين دورتموند', 'https://dortmund.termine-reservieren.de/', 'dortmund_tevis'),
            ('auslaenderbehoerde', 'Einwohnermeldewesen Dortmund (Aufenthaltstitel)', 'Immigration Services Dortmund', 'Міграційні послуги Дортмунд', 'Urząd ds. Cudzoziemców Dortmund', 'Yabancılar Hizmetleri Dortmund', 'خدمات الأجانب دورتموند', 'https://dortmund.termine-reservieren.de/', 'dortmund_tevis'),
        ],
        ...
        with get_connection() as conn:
            ...
            cursor.execute(
                ...
                INSERT OR IGNORE INTO termin_entitlements
                    (user_id, plan, slots_total, slots_used, stripe_session_id, active, found_termin, paid_until)
                VALUES (?, ?, ?, 0, ?, 1, 0, ?)
                """,
            ...
            conn.commit()
        logger.info(
            "upsert_entitlement | user=%s plan=%s session=%s inserted=%s",
            user_id, plan, stripe_session_id, cursor.rowcount,
        )
    except Exception as e:
    ...
    try:
        ...
        if ent.get("plan") == "7day" and ent.get("paid_until"):
            try:
                ...
                _expires = datetime.fromisoformat(ent["paid_until"])
