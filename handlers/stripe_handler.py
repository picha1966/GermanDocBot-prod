...
from handlers.termin_positioning import (
    get_termin_positioning_html,
    get_termin_positioning_short_html,
)
...
def build_post_payment_menu(
    ...
    # Last row: Main menu + Support — always shown so user is never left at a dead end
    rows.append([
        InlineKeyboardButton(
        ...
        InlineKeyboardButton(
            _BTN_SUPPORT.get(_lang, _BTN_SUPPORT["en"]),
            callback_data="ai_support",
        ),
    ])
...
# Compact intro on bundle-choice screen (PDF vs PDF+Termin) — before the final Stripe step.
PAYWALL_BUNDLE_CHOICE_INTRO = {
    "uk": (
        "📄 <b>PDF на основі ваших відповідей</b>\n"
        "⏱ <b>30–60 секунд</b> після оплати через Stripe\n\n"
    ),
    "ua": (
        "📄 <b>PDF на основі ваших відповідей</b>\n"
        "⏱ <b>30–60 секунд</b> після оплати через Stripe\n\n"
    ...
    "en": (
        "📄 <b>PDF based on your answers</b>\n"
        "⏱ <b>30–60 seconds</b> after payment via Stripe\n\n"
    ),
    "de": (
        "📄 <b>PDF basierend auf Ihren Angaben</b>\n"
        "⏱ <b>30–60 Sekunden</b> nach der Zahlung über Stripe\n\n"
    ),
    "pl": (
        "📄 <b>PDF na podstawie Twoich odpowiedzi</b>\n"
        "⏱ <b>30–60 sekund</b> po płatności przez Stripe\n\n"
    ),
    "tr": (
        "📄 <b>Yanıtlarınıza göre PDF</b>\n"
        "⏱ Ödemeden sonra <b>30–60 saniye</b> (Stripe)\n\n"
    ),
    "ar": (
        "📄 <b>ملف PDF بناءً على إجاباتك</b>\n"
        "⏱ <b>30–60 ثانية</b> بعد الدفع عبر Stripe\n\n"
    ),
}

# Full pre-checkout trust block — shown immediately before the Stripe pay button.
PAYWALL_PRE_CHECKOUT_BODY = {
    "uk": (
        "📄 <b>Ви отримаєте заповнений приклад документа</b> (PDF) на основі ваших відповідей\n\n"
        "⏱ <b>Готово за 30–60 секунд після оплати</b>\n\n"
        "✅ <b>Допомагає уникнути помилок, через які документи часто відхиляють</b>\n\n"
        "🔒 <b>Ваші дані використовуються лише для створення документа</b>\n\n"
        "⚠️ <b>Це не офіційна подача заявки і не гарантія прийняття</b>\n\n"
        "👤 <b>Підтримка відповідає протягом 24 годин</b>\n\n"
        "💸 <b>Якщо документ не підійшов — повернемо кошти</b>"
    ),
    "ua": (
        "📄 <b>Ви отримаєте заповнений приклад документа</b> (PDF) на основі ваших відповідей\n\n"
        "⏱ <b>Готово за 30–60 секунд після оплати</b>\n\n"
    ...
    "en": (
        "📄 <b>You will receive a filled document example</b> (PDF) based on your answers\n\n"
        "⏱ <b>Ready in 30–60 seconds after payment</b>\n\n"
        "✅ <b>Helps avoid common mistakes that lead to rejection</b>\n\n"
        "🔒 <b>Your data is used only to generate your document</b>\n\n"
        "⚠️ <b>This is not an official application and does not guarantee acceptance</b>\n\n"
        "👤 <b>Support replies within 24 hours</b>\n\n"
        "💸 <b>If the document doesn’t work for you — we’ll refund your payment</b>"
    ),
    "de": (
        "📄 <b>Sie erhalten ein ausgefülltes Dokumentenbeispiel</b> (PDF) basierend auf Ihren Angaben\n\n"
        "⏱ <b>Fertig in 30–60 Sekunden nach der Zahlung</b>\n\n"
        "✅ <b>Vermeidet typische Fehler, die zu Ablehnungen führen</b>\n\n"
        "🔒 <b>Ihre Daten werden nur zur Erstellung des Dokuments verwendet</b>\n\n"
        "⚠️ <b>Dies ist keine offizielle Antragstellung und keine Garantie für Annahme</b>\n\n"
        "👤 <b>Support antwortet innerhalb von 24 Stunden</b>\n\n"
        "💸 <b>Wenn das Dokument nicht passt — erstatten wir den Betrag</b>"
    ),
    "pl": (
        "📄 <b>Otrzymasz wypełniony przykład dokumentu</b> (PDF) na podstawie odpowiedzi\n\n"
        "⏱ <b>Gotowe w 30–60 sekund po płatności</b>\n\n"
        "✅ <b>Pomaga uniknąć typowych błędów prowadzących do odrzucenia</b>\n\n"
        "🔒 <b>Twoje dane są używane wyłącznie do wygenerowania dokumentu</b>\n\n"
        "⚠️ <b>To nie jest oficjalne złożenie wniosku i nie gwarantuje akceptacji</b>\n\n"
        "👤 <b>Wsparcie odpowiada w ciągu 24 godzin</b>\n\n"
        "💸 <b>Jeśli dokument się nie nada — zwrócimy pieniądze</b>"
    ),
    "tr": (
        "📄 <b>Doldurulmuş belge örneği alacaksınız</b> (PDF) — yanıtlarınıza göre\n\n"
        "⏱ <b>Ödeme sonrası 30–60 saniye içinde hazır</b>\n\n"
        "✅ <b>Reddedilmeye yol açan yaygın hataları önlemeye yardımcı olur</b>\n\n"
        "🔒 <b>Verileriniz yalnızca belgenizi oluşturmak için kullanılır</b>\n\n"
        "⚠️ <b>Bu resmi başvuru değildir ve kabul garantisi vermez</b>\n\n"
        "👤 <b>Destek 24 saat içinde yanıt verir</b>\n\n"
        "💸 <b>Belge işinize yaramazsa — ücreti iade ederiz</b>"
    ),
    "ar": (
        "📄 <b>ستحصل على مثال مستند مملوء</b> (PDF) بناءً على إجاباتك\n\n"
        "⏱ <b>جاهز خلال 30–60 ثانية بعد الدفع</b>\n\n"
        "✅ <b>يساعد على تجنب الأخطاء الشائعة التي تؤدي إلى الرفض</b>\n\n"
        "🔒 <b>تُستخدم بياناتك فقط لإنشاء المستند</b>\n\n"
        "⚠️ <b>هذا ليس تقديماً رسمياً للطلب ولا يضمن القبول</b>\n\n"
        "👤 <b>الدعم يرد خلال 24 ساعة</b>\n\n"
        "💸 <b>إذا لم يكن المستند مناسباً — نعيد المبلغ</b>"
    ),
}

# Extra trust lines — appended after PAYWALL_PRE_CHECKOUT_BODY, before Termin bundle block.
TRUST_BLOCK_HTML = {
    "uk": (
        "🔒 <b>Безпечна оплата через Stripe</b> (як у Amazon / Booking)\n"
        "👥 Вже допомогли користувачам у Berlin, München, Köln"
    ),
    "ua": (
        "🔒 <b>Безпечна оплата через Stripe</b> (як у Amazon / Booking)\n"
        "👥 Вже допомогли користувачам у Berlin, München, Köln"
    ...
    "en": (
        "🔒 <b>Secure payment via Stripe</b> (like Amazon / Booking)\n"
        "👥 Already helped users in Berlin, München, Köln"
    ),
    "de": (
        "🔒 <b>Sichere Zahlung über Stripe</b> (wie bei Amazon / Booking)\n"
        "👥 Bereits Nutzern in Berlin, München, Köln geholfen"
    ),
    "pl": (
        "🔒 <b>Bezpieczna płatność przez Stripe</b> (jak w Amazon / Booking)\n"
        "👥 Pomogliśmy użytkownikom m.in. w Berlin, München, Köln"
    ),
    "tr": (
        "🔒 <b>Stripe ile güvenli ödeme</b> (Amazon / Booking benzeri)\n"
        "👥 Berlin, München, Köln’de kullanıcılara yardımcı olduk"
    ),
    "ar": (
        "🔒 <b>دفع آمن عبر Stripe</b> (مثل Amazon / Booking)\n"
        "👥 ساعدنا مستخدمين في Berlin وMünchen وKöln"
    ),
}
...
def _resolve_order_lang(order: dict, user_id: int) -> str:
    """Order language → DB profile → uk. No silent fallback to en."""
    ol = ((order or {}).get("lang") or "").strip().lower()
    if ol == "ua":
        ol = "uk"
    ul = (get_user_lang(user_id) or "").strip().lower()
    if ul == "ua":
        ul = "uk"
    raw = ol or ul or "uk"
    if raw in ("uk", "en", "de", "pl", "tr", "ar"):
        return raw
    return "uk"


def _paywall_lang(order: dict, user_id: int) -> str:
    return _resolve_order_lang(order, user_id)


def _email_from_order_user_data(order: dict) -> Optional[str]:
    """Email from WebApp answers (order.user_data), for Stripe metadata + prefill."""
    try:
        raw = (order or {}).get("user_data")
        if isinstance(raw, dict):
            ud = raw
        else:
            ud = json.loads(raw or "{}")
        e = (ud.get("email") or "").strip()
...
# ============================================================================
# POST-PAYMENT EMAIL CAPTURE — shown when no email after Apple Pay
# ============================================================================
_EMAIL_CAPTURE_WAITING: Dict[int, Dict] = {}  # {user_id: {order_id, ts, lang}}
_EMAIL_CAPTURE_GC_STARTED: bool = False


async def _email_capture_gc_loop() -> None:
    """Evict _EMAIL_CAPTURE_WAITING entries older than TTL so abandoned
    flows don't accumulate in memory for the lifetime of the process."""
    while True:
        await asyncio.sleep(120)
        _now = _time.monotonic()
        _stale = [
            uid for uid, ctx in list(_EMAIL_CAPTURE_WAITING.items())
            if _now - ctx.get("ts", 0) > 600
        ]
        for uid in _stale:
            _EMAIL_CAPTURE_WAITING.pop(uid, None)
        if _stale:
            logger.info("EMAIL_CAPTURE_GC: evicted %d stale entr%s",
                        len(_stale), "y" if len(_stale) == 1 else "ies")

_EMAIL_CAPTURE_OFFER: Dict[str, str] = {
    "uk": "📧 Хочете отримати цей PDF на e-mail?",
    "ua": "📧 Хочете отримати цей PDF на e-mail?",
    "en": "📧 Want to receive this PDF by email?",
    "de": "📧 Möchten Sie dieses PDF per E-Mail erhalten?",
    "pl": "📧 Chcesz otrzymać ten PDF na e-mail?",
    "tr": "📧 Bu PDF'yi e-posta ile almak ister misiniz?",
    "ar": "📧 هل تريد استلام هذا الملف على بريدك الإلكتروني؟",
}
_EMAIL_CAPTURE_ENTER_BTN: Dict[str, str] = {
    "uk": "✉️ Ввести email",
    "ua": "✉️ Ввести email",
    "en": "✉️ Enter email",
    "de": "✉️ E-Mail eingeben",
    "pl": "✉️ Wpisz email",
    "tr": "✉️ E-posta gir",
    "ar": "✉️ أدخل البريد الإلكتروني",
}
_EMAIL_CAPTURE_SKIP_BTN: Dict[str, str] = {
    "uk": "Пропустити",
    "ua": "Пропустити",
    "en": "Skip",
    "de": "Überspringen",
...
_EMAIL_CAPTURE_ASK: Dict[str, str] = {
    "uk": "✏️ Введіть ваш email:",
    "ua": "✏️ Введіть ваш email:",
    "en": "✏️ Please enter your email:",
    "de": "✏️ Bitte geben Sie Ihre E-Mail ein:",
    "pl": "✏️ Podaj swój adres email:",
    "tr": "✏️ Lütfen e-posta adresinizi girin:",
    "ar": "✏️ الرجاء إدخال بريدك الإلكتروني:",
}
_EMAIL_CAPTURE_SUCCESS: Dict[str, str] = {
    "uk": (
        "✅ PDF надіслано на ваш email.\n\n"
        "Перевірте також папку Spam/Promotions, якщо лист не зʼявився протягом 1–2 хвилин.\n\n"
        "Що хочете зробити далі?"
    ),
    "en": (
        "✅ PDF sent to your email.\n\n"
        "Please also check your Spam/Promotions folder if the email doesn't arrive within 1–2 minutes.\n\n"
        "What would you like to do next?"
    ),
    "de": (
        "✅ PDF wurde an Ihre E-Mail gesendet.\n\n"
        "Bitte prüfen Sie auch den Spam-/Promotions-Ordner, falls die E-Mail nicht innerhalb von 1–2 Minuten ankommt.\n\n"
        "Was möchten Sie als nächstes tun?"
    ),
    "pl": (
        "✅ PDF wysłany na Twój email.\n\n"
        "Sprawdź również folder Spam/Promocje, jeśli wiadomość nie pojawi się w ciągu 1–2 minut.\n\n"
        "Co chcesz zrobić dalej?"
    ),
    "tr": (
        "✅ PDF e-postanıza gönderildi.\n\n"
        "E-posta 1–2 dakika içinde gelmezse Spam/Promosyonlar klasörünüzü kontrol edin.\n\n"
        "Sırada ne yapmak istersiniz?"
    ),
    "ar": (
        "✅ تم إرسال PDF إلى بريدك الإلكتروني.\n\n"
        "تحقق أيضًا من مجلد Spam/Promotions إذا لم تصل الرسالة خلال 1–2 دقيقة.\n\n"
        "ماذا تريد أن تفعل بعد ذلك؟"
    ),
}
_EMAIL_POST_BTN_TERMIN: Dict[str, str] = {
...
_EMAIL_POST_BTN_NEW_DOC: Dict[str, str] = {
    "uk": "📄 Створити ще один документ",
    "en": "📄 Create another document",
    "de": "📄 Weiteres Dokument erstellen",
    "pl": "📄 Utwórz kolejny dokument",
    "tr": "📄 Başka belge oluştur",
    "ar": "📄 إنشاء وثيقة أخرى",
}
_EMAIL_POST_BTN_MAIN: Dict[str, str] = {
    "uk": "🏠 Головне меню",
    "en": "🏠 Main menu",
    "de": "🏠 Hauptmenü",
    "pl": "🏠 Menu główne",
...
_EMAIL_POST_BTN_SUPPORT: Dict[str, str] = {
    "uk": "🆘 Підтримка",
    "en": "🆘 Support",
    "de": "🆘 Support",
    "pl": "🆘 Wsparcie",
...
_EMAIL_CAPTURE_INVALID: Dict[str, str] = {
    "uk": "❌ Невірний email. Спробуйте ще раз.",
    "ua": "❌ Невірний email. Спробуйте ще раз.",
    "en": "❌ Invalid email. Please try again.",
    "de": "❌ Ungültige E-Mail. Bitte versuchen Sie es erneut.",
    "pl": "❌ Nieprawidłowy email. Spróbuj ponownie.",
    "tr": "❌ Geçersiz e-posta. Lütfen tekrar deneyin.",
    "ar": "❌ بريد إلكتروني غير صالح. حاول مجدداً.",
}
_EMAIL_CAPTURE_EXPIRED: Dict[str, str] = {
    "uk": "⏱ Сесія введення email завершилась. Натисніть кнопку «✉️ Ввести email» ще раз — PDF надішлемо відразу.",
    "ua": "⏱ Сесія введення email завершилась. Натисніть кнопку «✉️ Ввести email» ще раз — PDF надішлемо відразу.",
    "en": "⏱ Email session expired. Tap «✉️ Enter email» again — your PDF will be sent right away.",
    "de": "⏱ E-Mail-Sitzung abgelaufen. Tippen Sie erneut auf «✉️ E-Mail eingeben» — das PDF wird sofort gesendet.",
    "pl": "⏱ Sesja email wygasła. Naciśnij ponownie «✉️ Wpisz email» — PDF zostanie wysłany od razu.",
    "tr": "⏱ E-posta oturumu sona erdi. «✉️ E-posta gir» butonuna tekrar dokunun — PDF hemen gönderilecek.",
    "ar": "⏱ انتهت جلسة البريد الإلكتروني. اضغط على «✉️ أدخل البريد الإلكتروني» مجدداً — سيُرسل PDF فوراً.",
}


async def send_email_capture_offer(bot, user_id: int, order_id: int, lang: str = "uk") -> None:
    """Send 'Want PDF by email?' prompt after payment when no email is available.

    Idempotent: the DB claim (email_capture_offered=1) ensures the offer is
    sent exactly once even if both bot.py and delivery_retry.py trigger it.
    """
    # ── Pre-flight: skip if email already captured or sent ──────────────────
    try:
        _db_cap = get_db()
        _ord_cap = _db_cap.get_order(order_id)
        if not _ord_cap:
            logger.warning("EMAIL_CAPTURE_OFFER_NO_ORDER order=%s", order_id)
            return
        if _ord_cap.get("customer_email") or _ord_cap.get("email_sent"):
            logger.info(
                "EMAIL_CAPTURE_OFFER_SKIP order=%s — email already captured or sent",
                order_id,
            )
            return
        # Atomic claim — only one caller wins
        if not _db_cap.claim_email_capture_offer(order_id):
            logger.info("EMAIL_CAPTURE_OFFER_ALREADY_SENT order=%s — duplicate skipped", order_id)
            return
    except Exception as _pre_exc:
        logger.warning("EMAIL_CAPTURE_OFFER_PREFLIGHT_ERROR order=%s err=%s", order_id, _pre_exc)
        # Fall through — sending a duplicate offer is better than silently failing
    # ────────────────────────────────────────────────────────────────────────
    _l = lang if lang in _EMAIL_CAPTURE_OFFER else "uk"
    kb = InlineKeyboardMarkup(row_width=2)
    kb.add(
        InlineKeyboardButton(
            _EMAIL_CAPTURE_ENTER_BTN.get(_l, _EMAIL_CAPTURE_ENTER_BTN["uk"]),
            callback_data=f"enter_email_{order_id}",
        ),
        InlineKeyboardButton(
            _EMAIL_CAPTURE_SKIP_BTN.get(_l, _EMAIL_CAPTURE_SKIP_BTN["uk"]),
    ...
    try:
        await bot.send_message(
            user_id,
            _EMAIL_CAPTURE_OFFER.get(_l, _EMAIL_CAPTURE_OFFER["uk"]),
            reply_markup=kb,
        )
        logger.info("EMAIL_CAPTURE_OFFER_SENT order=%s user=%s", order_id, user_id)
    except Exception as exc:
        logger.warning("EMAIL_CAPTURE_OFFER_FAILED order=%s user=%s err=%s", order_id, user_id, exc)


async def handle_enter_email_callback(callback: types.CallbackQuery, state: FSMContext):
    """User tapped 'Enter email' after PDF was delivered without email."""
    ...
    lang = _paywall_lang(order, user_id)
    _l = lang if lang in _EMAIL_CAPTURE_ASK else "uk"

    from aiogram.types import ForceReply
    await callback.message.answer(
        _EMAIL_CAPTURE_ASK.get(_l, _EMAIL_CAPTURE_ASK["uk"]),
        reply_markup=ForceReply(),
    )
    # Set state only after the prompt is delivered so a send failure
    # doesn't leave the user stuck in waiting_email_for_pdf silently.
    _EMAIL_CAPTURE_WAITING[user_id] = {
        "order_id": order_id,
        "ts": _time.monotonic(),
        "lang": lang,
    }
    await state.set_state(DocumentState.waiting_email_for_pdf)
    try:
...
async def handle_skip_email_callback(callback: types.CallbackQuery, state: FSMContext):
    """User tapped 'Skip' — dismiss the email offer."""
    await callback.answer()
    try:
        await callback.message.edit_reply_markup(reply_markup=None)
    except Exception:
        pass
    # Clear FSM state and context if user skips while waiting_email_for_pdf is active.
    # Without this, the state stays set from a prior "Enter email" tap and every
    # subsequent message is captured as email input.
    user_id = callback.from_user.id
    try:
        current = await state.get_state()
        if current == DocumentState.waiting_email_for_pdf.state:
            _EMAIL_CAPTURE_WAITING.pop(user_id, None)
            await state.finish()
    except Exception:
        pass


async def handle_email_capture_input(message: types.Message, state: FSMContext):
    """User typed their email while in waiting_email_for_pdf state."""
    user_id = message.from_user.id
    ctx = _EMAIL_CAPTURE_WAITING.get(user_id)  # peek — not popped yet

    if not ctx or _time.monotonic() - ctx.get("ts", 0) > 600:
        if ctx:
            lang = ctx.get("lang", "uk")
            _l_exp = lang if lang in _EMAIL_CAPTURE_EXPIRED else "uk"
            logger.info(
                "EMAIL_CAPTURE_EXPIRED user=%s order=%s",
                user_id, ctx.get("order_id"),
            )
        else:
            _l_exp = "uk"
        _EMAIL_CAPTURE_WAITING.pop(user_id, None)
        await state.finish()
        await message.answer(_EMAIL_CAPTURE_EXPIRED.get(_l_exp, _EMAIL_CAPTURE_EXPIRED["uk"]))
        return

    order_id = ctx["order_id"]
    lang = ctx.get("lang", "uk")
    _l = lang if lang in _EMAIL_CAPTURE_SUCCESS else "uk"
    email = (message.text or "").strip()

    if "@" not in email or "." not in email.split("@")[-1]:
        # State stays active — user can type again
        await message.answer(_EMAIL_CAPTURE_INVALID.get(_l, _EMAIL_CAPTURE_INVALID["uk"]))
        return

    # Valid email — now commit: pop context and finish state
    _EMAIL_CAPTURE_WAITING.pop(user_id, None)
    await state.finish()
    ...
    # Persist email to both orders and users tables so resolve_email_for_order finds it
    try:
        db.save_customer_email(order_id, email, overwrite=True)
    except Exception as exc:
        logger.warning("EMAIL_CAPTURE_SAVE_ORDER failed order=%s err=%s", order_id, exc)
    try:
        from backend.termin_db import create_user as _crt_u, update_user as _upd_u
        _crt_u(str(user_id))
        _upd_u(str(user_id), customer_email=email)
    except Exception as exc:
        logger.warning("EMAIL_CAPTURE_SAVE_USER failed user=%s err=%s", user_id, exc)

    logger.info("EMAIL_CAPTURE_SUCCESS order=%s user=%s email_present=True", order_id, user_id)

    _post_kb = InlineKeyboardMarkup(row_width=2)
    _post_kb.add(
        InlineKeyboardButton(
            _EMAIL_POST_BTN_TERMIN.get(_l, _EMAIL_POST_BTN_TERMIN["uk"]),
            callback_data="find_termin",
        ),
        InlineKeyboardButton(
            _EMAIL_POST_BTN_NEW_DOC.get(_l, _EMAIL_POST_BTN_NEW_DOC["uk"]),
            callback_data="create_doc",
        ),
    )
    _post_kb.add(
        InlineKeyboardButton(
            _EMAIL_POST_BTN_MAIN.get(_l, _EMAIL_POST_BTN_MAIN["uk"]),
            callback_data="back_to_main_menu",
        ),
        InlineKeyboardButton(
            _EMAIL_POST_BTN_SUPPORT.get(_l, _EMAIL_POST_BTN_SUPPORT["uk"]),
            callback_data="ai_support",
        ),
    )
    await message.answer(
        _EMAIL_CAPTURE_SUCCESS.get(_l, _EMAIL_CAPTURE_SUCCESS["uk"]),
        reply_markup=_post_kb,
    )

    # Re-send PDF to the captured email using already-stored pdf_path
    from utils.delivery_retry import _attempt_email_after_delivery
    logger.info("EMAIL_RESEND_TRIGGERED order=%s", order_id)
    asyncio.create_task(_attempt_email_after_delivery(order_id))
...
async def initiate_payment(callback_query: types.CallbackQuery):
    ...
    if is_bundle is None:  # pay_{id}
        body = PAYWALL_BUNDLE_CHOICE_INTRO.get(
            lang, PAYWALL_BUNDLE_CHOICE_INTRO.get("en", "")
        )
        ...
        _termin_pos = get_termin_positioning_short_html(lang)
    ...
    log_funnel(
        ...
        order_id=order_id,
        plan="bundle" if is_bundle else "pdf",
    ...
    body = PAYWALL_PRE_CHECKOUT_BODY.get(lang, PAYWALL_PRE_CHECKOUT_BODY.get("en", ""))
    log_funnel(
        "VIEW_PAYWALL",
        user_id,
        doc_type=order.get("doc_type"),
    ...
    _SECURE_BADGE = {
        "uk": "🔒 Безпечна оплата через Stripe (як у Amazon / Booking)",
        "ua": "🔒 Безпечна оплата через Stripe (як у Amazon / Booking)",
        "en": "🔒 Secure payment via Stripe (like Amazon / Booking)",
        "de": "🔒 Sichere Zahlung über Stripe (wie Amazon / Booking)",
        "pl": "🔒 Bezpieczna płatność przez Stripe (jak Amazon / Booking)",
        "tr": "🔒 Stripe ile güvenli ödeme (Amazon / Booking gibi)",
        "ar": "🔒 دفع آمن عبر Stripe (مثل Amazon / Booking)",
    }
    _badge = _SECURE_BADGE.get(lang, _SECURE_BADGE["en"])
    _termin_pre_checkout = ""
    if is_bundle:
        _termin_pre_checkout = "\n\n" + get_termin_positioning_html(lang)
    _trust_block = TRUST_BLOCK_HTML.get(
        lang, TRUST_BLOCK_HTML.get("uk" if (lang or "").strip().lower() == "ua" else lang, TRUST_BLOCK_HTML["en"])
    )
    message_text = f"{_summary_block}{body}\n\n{_trust_block}{_termin_pre_checkout}"
...
async def send_final_pdf(bot: Bot, user_id: int, order_id: int) -> None:
    ...
    if not doc_type:
        ...
        return
    lang = _resolve_order_lang(order, user_id)
    logger.info(
    ...
    if isinstance(result, dict):
        ...
        _missing = result.get("missing_fields") or [
            m.get("key", "") for m in (result.get("errors") or [])
        ]
        logger.error(
            "send_final_pdf: STOP — validation_failed order_id=%s status=%s missing=%s",
            order_id,
            _status,
            _missing,
        )
        try:
            _sfp_err_texts = {
                "uk": "❌ Не вдалося згенерувати документ. Будь ласка, зверніться до підтримки або поверніться до головного меню.",
                "en": "❌ We couldn't generate your document. Please contact support or return to the main menu.",
                "de": "❌ Wir konnten Ihr Dokument nicht erstellen. Bitte kontaktieren Sie den Support oder kehren Sie zum Hauptmenü zurück.",
                "pl": "❌ Nie udało się wygenerować dokumentu. Skontaktuj się z pomocą techniczną lub wróć do menu głównego.",
                "tr": "❌ Belgenizi oluşturamadık. Lütfen destek ile iletişime geçin veya ana menüye dönün.",
                "ar": "❌ لم نتمكن من إنشاء مستندك. يرجى التواصل مع الدعم أو العودة إلى القائمة الرئيسية.",
            }
            _sfp_lang = "uk" if lang in ("ua", "uk") else (lang if lang in _sfp_err_texts else "en")
            _sfp_kb = InlineKeyboardMarkup(row_width=2)
            _sfp_kb.add(
                InlineKeyboardButton(_BTN_MAIN_MENU.get(_sfp_lang, _BTN_MAIN_MENU["en"]), callback_data="main_menu"),
                InlineKeyboardButton(_BTN_SUPPORT.get(_sfp_lang, _BTN_SUPPORT["en"]), callback_data="ai_support"),
            )
            await bot.send_message(
                chat_id=user_id,
                text=_sfp_err_texts.get(_sfp_lang, _sfp_err_texts["en"]),
                reply_markup=_sfp_kb,
            )
        except Exception:
            pass
        return
    ...
    for _attempt in range(1, _max_attempts + 1):
        try:
            ...
            log_funnel(
                ...
                doc_type=doc_type,
                lang=lang,
                city=funnel_city_from_mapping(user_data),
                order_id=order_id,
            )
            _sent = True
            break
...
def _ltv_normalize_lang(lang: Optional[str]) -> str:
...
# LTV: second action after PDF (Termin vs cross-sell documents) — uk, en, de, pl, tr, ar
_LTV_TERMIN_PROMPT: Dict[str, str] = {
    "uk": (
        "⚡ <b>Хочете отримати Termin швидше?</b>\n\n"
        "Натисніть нижче — допоможемо знайти запис у відповідному органі."
    ),
    "en": (
        "⚡ <b>Want to get a Termin (appointment) faster?</b>\n\n"
        "Tap below — we’ll help you find a slot at the right office."
    ),
    "de": (
        "⚡ <b>Möchten Sie schneller einen Termin bekommen?</b>\n\n"
        "Tippen Sie unten — wir helfen Ihnen, einen Termin bei der richtigen Behörde zu finden."
    ),
    "pl": (
        "⚡ <b>Chcesz szybciej dostać termin (Termin)?</b>\n\n"
        "Kliknij poniżej — pomożemy znaleźć termin w odpowiednim urzędzie."
    ),
    "tr": (
        "⚡ <b>Termin (randevu) almayı daha hızlı ister misiniz?</b>\n\n"
        "Aşağıya dokunun — doğru kurumda randevu bulmanıza yardımcı olalım."
    ),
    "ar": (
        "⚡ <b>هل تريد الحصول على موعد (Termin) بشكل أسرع؟</b>\n\n"
        "اضغط أدناه — نساعدك في إيجاد موعد في الجهة المناسبة."
    ),
}

_LTV_DOCS_HEADER: Dict[str, str] = {
    "uk": "📎 <b>Вам може знадобитися ще один документ</b>",
    "en": "📎 <b>You might need another document</b>",
    "de": "📎 <b>Vielleicht brauchen Sie noch ein weiteres Dokument</b>",
    "pl": "📎 <b>Może przyda Ci się jeszcze jeden dokument</b>",
    "tr": "📎 <b>Bir belge daha gerekebilir</b>",
    "ar": "📎 <b>قد تحتاج إلى مستندًا آخر</b>",
}

_LTV_BTN_FIND_TERMIN: Dict[str, str] = {
    "uk": "🔎 Знайти Termin",
    "ua": "🔎 Знайти Termin",
    "en": "🔎 Find Termin",
    "de": "🔎 Termin finden",
...
async def send_ltv_post_pdf_followup(
    bot_instance: Bot,
    user_id: int,
    doc_type: Optional[str],
    city: Optional[str],
    ...
    """
    After a paid PDF is delivered: suggest Termin (if user has no active Termin entitlement)
    or cross-sell 2–3 other document types (if user already has Termin).
    UI-only — never raises; failures are logged.
    """
    _l = _ltv_normalize_lang(lang)
    try:
        from backend.termin_db import is_termin_entitled

        _has_termin = is_termin_entitled(str(user_id))
    except Exception as _e:
        logger.debug("send_ltv_post_pdf_followup: is_termin_entitled failed user=%s err=%s", user_id, _e)
        _has_termin = False

    _city_log = (city or "").strip() or None

    try:
        if not _has_termin:
            log_funnel(
                "POST_PAYMENT_UPSELL_SHOWN",
                user_id,
                doc_type=doc_type,
                lang=_l,
                city=_city_log,
            ...
            text = _LTV_TERMIN_PROMPT.get(_l, _LTV_TERMIN_PROMPT["en"])
            btn = _LTV_BTN_FIND_TERMIN.get(_l, _LTV_BTN_FIND_TERMIN["en"])
            kb = InlineKeyboardMarkup().add(
                InlineKeyboardButton(btn, callback_data="termin_from_pdf")
            )
            await bot_instance.send_message(
                chat_id=int(user_id),
                text=text,
            ...
            logger.info("LTV_SENT: termin_upsell user=%s doc=%s", user_id, doc_type)
            return
        ...
        header = _LTV_DOCS_HEADER.get(_l, _LTV_DOCS_HEADER["en"])
        ...
        for _rd in _related:
            ...
            kb.add(InlineKeyboardButton(f"📄 {_name}", callback_data=f"upsell_doc_{_rd}"))
        ...
        logger.info("LTV_SENT: doc_cross_sell user=%s doc=%s related=%s", user_id, doc_type, _related)
    except Exception as _ltv_err:
        logger.debug(
            "send_ltv_post_pdf_followup failed user=%s doc=%s err=%s",
            user_id,
            doc_type,
            _ltv_err,
        )
...
async def delayed_ltv_post_pdf_followup(
    bot_instance: Bot,
    user_id: int,
    doc_type: Optional[str],
    city: Optional[str],
    ...
    """
    Single scheduling path (webhook): wait ~1s after PDF message, then LTV upsell.
    Swallows errors — never breaks the payment flow.
    """
    try:
        await asyncio.sleep(1)
        await send_ltv_post_pdf_followup(bot_instance, user_id, doc_type, city, lang)
    except Exception as _e:
        logger.debug("delayed_ltv_post_pdf_followup user=%s err=%s", user_id, _e)
...
async def deliver_document_after_payment(
    ...
    # ── Product-type guard: never attempt PDF delivery for Termin products ────
    # Termin orders (monitor, reservation, family, etc.) are fulfilled by their
    # own webhook activation paths in bot.py.  If they reach this function it
    # means the retry system picked them up as a stuck PAID/FAILED order — that
    # is incorrect and we must bail out cleanly rather than trying to generate a PDF.
    from utils.delivery_retry import _NON_PDF_DOC_TYPES as _skip_doc_types
    _order_doc_type = (order.get("doc_type") or "").strip().lower()
    if _order_doc_type in _skip_doc_types:
        logger.info(
            "DELIVERY_SKIP_NON_PDF_ORDER | order_id=%s product_type=termin "
            "doc_type=%s user_id=%s — PDF delivery skipped for non-PDF product",
            order_id, _order_doc_type, user_id,
        )
        return True  # treat as already-handled; no retry needed
    # ─────────────────────────────────────────────────────────────────────────
...
async def _deliver_document_inner(
    ...
    _ud_keys_lower = {k.lower() for k in user_data}
    _has_iban  = any("iban" in k for k in _ud_keys_lower)
    _has_email = any("email" in k or "mail" in k for k in _ud_keys_lower)
    _has_phone = any("phone" in k or "tel" in k or "mobil" in k for k in _ud_keys_lower)
    logger.info(
        "USER_DATA_SUMMARY | order_id=%s user_id=%s doc_type=%s fields=%s "
        "has_iban=%s has_email=%s has_phone=%s",
        order_id, user_id, order.get("doc_type"), len(user_data),
        _has_iban, _has_email, _has_phone,
    )
    ...
    # UX: processing notice before PDF generation (may take several seconds).
    # Skip when skip_pdf_send=True — bot.py webhook sends ONE consolidated receipt
    # message that already covers this, so a separate "⏳ Generating..." here would
    # be a duplicate and confusing on retry.
    if not skip_pdf_send:
        try:
            from handlers.post_payment_ux import get_pdf_processing_message

            await bot_instance.send_message(
                chat_id=user_id,
                text=get_pdf_processing_message(lang),
                parse_mode="HTML",
            )
        except Exception as _proc_err:
            logger.debug(
                "PDF_PROCESSING_MSG_FAILED order_id=%s err=%s", order_id, _proc_err
            )
    try:
    ...
    if doc_type.lower() == "ummeldung":
        ...
        # skip_pdf_send=True means the caller (bot.py webhook) will send canonical part itself —
        # skip Telegram sends here to avoid part-1 duplicate, but still clean up non-canonical parts.
        if not skip_pdf_send:
            ...
            # skip_pdf_send=True: caller will send canonical part — only clean up non-canonical parts now.
            logger.info(
                "UMMELDUNG_PDF_SEND_DEFERRED: order_id=%s %d part(s) — caller sends canonical",
                order_id, len(pdf_paths),
            )
            try:
                from backend.utils.pdf_cleanup import delete_pdf_after_delivery
                for _fp in pdf_paths[1:]:
                    delete_pdf_after_delivery(_fp)
            except Exception as _ce:
                logger.warning(
                    "deliver_document_after_payment: ummeldung deferred cleanup failed: %s", _ce
                )
    else:
        ...
        try:
            ...
            _pdf_err_text = {
                "uk": "❌ Помилка при генерації документа. Зверніться до підтримки.",
                "en": "❌ Error generating document. Please contact support.",
                "de": "❌ Fehler beim Erstellen des Dokuments. Bitte wenden Sie sich an den Support.",
                "pl": "❌ Błąd generowania dokumentu. Skontaktuj się z pomocą techniczną.",
                "tr": "❌ Belge oluşturma hatası. Lütfen destek ile iletişime geçin.",
                "ar": "❌ خطأ في إنشاء المستند. يرجى التواصل مع الدعم.",
            }
            _pdf_err_lang = ("uk" if lang in ("ua", "uk") else lang) if lang else "en"
            if _pdf_err_lang not in _pdf_err_text:
                _pdf_err_lang = "en"
            try:
                _pdf_exc_kb = InlineKeyboardMarkup(row_width=2)
                _pdf_exc_kb.add(
                    InlineKeyboardButton(_BTN_MAIN_MENU.get(_pdf_err_lang, _BTN_MAIN_MENU["en"]), callback_data="main_menu"),
                    InlineKeyboardButton(_BTN_SUPPORT.get(_pdf_err_lang, _BTN_SUPPORT["en"]), callback_data="ai_support"),
                )
                await bot_instance.send_message(
                    chat_id=user_id,
                    text=_pdf_err_text.get(_pdf_err_lang, _pdf_err_text["en"]),
                    reply_markup=_pdf_exc_kb,
                )
            except Exception:
                pass
            db.update_order_status(order_id, OrderStatus.FAILED)
        ...
        if isinstance(file_path, dict):
            ...
            try:
                ...
                _dap_val_lang = _pdf_err_lang if _pdf_err_lang in _dap_val_texts else "en"
                _dap_val_kb = InlineKeyboardMarkup(row_width=2)
                _dap_val_kb.add(
                    InlineKeyboardButton(_BTN_MAIN_MENU.get(_dap_val_lang, _BTN_MAIN_MENU["en"]), callback_data="main_menu"),
                    InlineKeyboardButton(_BTN_SUPPORT.get(_dap_val_lang, _BTN_SUPPORT["en"]), callback_data="ai_support"),
                )
                await bot_instance.send_message(
                    chat_id=user_id,
                    text=_dap_val_texts.get(_dap_val_lang, _dap_val_texts["en"]),
                    reply_markup=_dap_val_kb,
                )
            except Exception:
                pass
            db.update_order_status(order_id, OrderStatus.FAILED)
...
async def deliver_document(
    ...
    if isinstance(user_data_raw, dict):
        ...
        try:
            ...
            logger.error(
                "deliver_document: USER_DATA_JSON_INVALID order_id=%s err=%s",
                order_id, _json_err,
            )
            user_data = {}
    ...
    except Exception as _proc_dl:
        logger.debug(
            "PDF_PROCESSING_MSG_FAILED deliver_document order_id=%s err=%s",
            order_id,
            _proc_dl,
        )
    try:
        await bot.send_chat_action(user_id, action="upload_document")
    except Exception:
        pass
    ...
    if doc_type.lower() == "ummeldung":
        ...
        _base = f"ummeldung_{user_id}_{order_id}"
        _dl_ummeldung_loop = asyncio.get_event_loop()
        pdf_paths = await _dl_ummeldung_loop.run_in_executor(
            None,
            lambda: build_ummeldung_pdfs(
                user_data=user_data,
                output_dir=str(OUTPUT_DIR),
        ...
        try:
            ...
            logger.error(
                "deliver_document: create_final_pdf RAISED order_id=%s err=%s",
                order_id,
                _pdf_exc,
                exc_info=True,
            )
            raise RuntimeError(
                f"deliver_document: PDF_GENERATION_EXCEPTION order_id={order_id}"
            ) from _pdf_exc
        ...
        if isinstance(file_path, dict):
            ...
            logger.error(
                "deliver_document: validation_failed order_id=%s missing=%s",
                order_id,
                _missing,
            )
            try:
                ...
                _dl_val_lang = "uk" if lang in ("ua", "uk") else (lang if lang in _dl_val_texts else "en")
                _dl_val_kb = InlineKeyboardMarkup(row_width=2)
                _dl_val_kb.add(
                    InlineKeyboardButton(_BTN_MAIN_MENU.get(_dl_val_lang, _BTN_MAIN_MENU["en"]), callback_data="main_menu"),
                    InlineKeyboardButton(_BTN_SUPPORT.get(_dl_val_lang, _BTN_SUPPORT["en"]), callback_data="ai_support"),
                )
                await bot.send_message(
                    chat_id=user_id,
                    text=_dl_val_texts.get(_dl_val_lang, _dl_val_texts["en"]),
                    reply_markup=_dl_val_kb,
                )
            except Exception:
                pass
            raise RuntimeError(
                f"deliver_document: VALIDATION_FAILED order_id={order_id} missing={_missing}"
            )
        ...
        try:
            ...
            # Roll back to FAILED so the startup sweep or retry can re-deliver.
            # Without this, the order stays in PROCESSING forever when a claim was taken.
            try:
                db.update_order_status(order_id, OrderStatus.FAILED)
                logger.warning(
                    "deliver_document: SEND_FAILED order_id=%s — rolled back to FAILED: %s",
                    order_id, _send_exc,
                )
            except Exception as _rb_err:
                logger.error(
                    "deliver_document: ROLLBACK_FAILED order_id=%s err=%s", order_id, _rb_err
                )
            raise
        log_funnel(
            "PDF_DELIVERED",
...
def register_handlers(dp: Dispatcher):
    ...
    # Post-payment email capture (Apple Pay / no-email flow)
    dp.register_callback_query_handler(
        handle_enter_email_callback,
        lambda c: c.data and c.data.startswith("enter_email_"),
    )
    dp.register_callback_query_handler(
        handle_skip_email_callback,
        lambda c: c.data == "skip_email",
    )
    dp.register_message_handler(
        handle_email_capture_input,
        state=DocumentState.waiting_email_for_pdf,
    )
    global _EMAIL_CAPTURE_GC_STARTED
    if not _EMAIL_CAPTURE_GC_STARTED:
        _EMAIL_CAPTURE_GC_STARTED = True
        asyncio.ensure_future(_email_capture_gc_loop())
