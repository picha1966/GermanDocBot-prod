...
async def _show_main_menu(message: types.Message, lang: str, greeting: str = ""):
    ...
    # Row 3: [⚙️ Settings]                       ← utility (Support moved inside Settings)
    ...
    kb.add(InlineKeyboardButton(_settings_btn_label.get(_l, _settings_btn_label["en"]), callback_data="settings_menu"))
    kb.row(
...
def _get_document_label(doc_type: str, lang: str, description_only: bool = False) -> str:
    ...
    doc_descriptions = {
        "anmeldung": {
            ...
            "ru": "Регистрация адреса в Германии",
            "de": "Anmeldung",
            "pl": "Rejestracja",
            "tr": "Kayıt",
            "ar": "التسجيل",
        ...
        "abmeldung": {
            ...
            "ru": "Снятие с регистрации при выезде",
            "de": "Abmeldung",
            "pl": "Wyrejestrowanie",
            "tr": "Kayıt silme",
            "ar": "إلغاء التسجيل",
        ...
        "wohnungsgeberbestaetigung": {
            ...
            "ru": "Подтверждение от арендодателя для регистрации",
        ...
        "unterhaltsvorschuss": {
            ...
            "ru": "Аванс по алиментам от государства",
        ...
        "anlage_kind": {
            ...
            "ru": "Данные ребенка для Kindergeld",
            "de": "Anlage Kind",
        ...
        "buergergeld": {
            ...
            "ru": "Заявление в Jobcenter на финансовую помощь",
            "de": "Bürgergeld",
        ...
        "wohngeld": {
            ...
            "ru": "Жилищное пособие для снижения расходов на аренду",
            "de": "Wohngeld",
        ...
        "arbeitslosengeld_1": {
            ...
            "ru": "Пособие по безработице после работы",
        ...
        "kuendigung": {
            ...
            "ru": "Шаблон письма для увольнения",
            "de": "Kündigung",
            "pl": "Wypowiedzenie",
            "tr": "Fesih",
            "ar": "الإنهاء",
...
async def _show_category_documents(message: types.Message, category: str, lang: str):
    ...
    category_titles = {
        ...
        "ru": {
            "residence": "🏠 <b>Жильё и регистрация</b>\n\nВыберите документ:",
            "financial": "💰 <b>Финансовые документы</b>\n\nВыберите документ:",
            "benefits": "💰 <b>Выплаты и поддержка</b>\n\nВыберите документ:",
            "employment": "💼 <b>Работа и занятость</b>\n\nВыберите документ:",
            "finance": "💰 <b>Выплаты и поддержка</b>\n\nВыберите документ:",
            "family": "💰 <b>Выплаты и поддержка</b>\n\nВыберите документ:",
        },
        "de": {
...
async def _show_termin_page(message: types.Message, lang: str):
    ...
    text = TERMIN_PAGE_TEXTS.get(text_lang, TERMIN_PAGE_TEXTS["uk"])
...
def register_handlers(dp: Dispatcher):
    """Реєстрація handlers в dispatcher"""
