...
from utils.retention import RETENTION_TERMIN_CB
...
from handlers.termin_positioning import get_termin_positioning_short_html
...
# DEV MODE toggle: when True, admins are forced into "new customer" flow.
DEV_FORCE_NEW_USER = False
...
def _dev_reset_if_needed(user_id: int) -> None:
    ...
    """
    _admin_ids = {str(x) for x in _get_admin_ids()}
    if not DEV_FORCE_NEW_USER:
        return
...
_PAYMENT_OFFER_TEXT = {
    ...
    "en": (
        ...
        "Continuous monitoring of official portals.\n"
    ...
    "de": (
        ...
        "Kontinuierliche Überwachung offizieller Portale.\n"
    ...
    "pl": (
        ...
        "Ciągły monitoring oficjalnych portali.\n"
    ...
    "tr": (
        ...
        "Resmi portalların sürekli izlenmesi.\n"
    ...
    "ar": (
        ...
        "مراقبة مستمرة للبوابات الرسمية.\n"
...
_PRE_PAYMENT_TEXT = {
    "uk": (
        ...
        "📄 <b>{service}</b>\n\n"
        "Ми шукаємо вільні слоти і надсилаємо пряме посилання.\n"
        "Ти бронюєш сам — швидко й офіційно.\n"
        "⚡ Слот може зникнути за хвилини — дій одразу.\n\n"
        "💡 Після оплати можна просто закрити сторінку — ми все зробимо автоматично.\n\n"
        "💶 <b>Оберіть план:</b>\n"
        "⭐ <b>Найкраща ціна: 30 днів — €19.99</b>\n"
        "   Автоматичний моніторинг 30 днів. Ми сповістимо, коли з'явиться слот. Наявність не гарантована.\n"
        "📅 7 днів — €12.99\n"
    ...
    "en": (
        "🔎 <b>Termin Monitoring — {city}</b>\n\n"
        "📄 <b>{service}</b>\n\n"
        "We find open slots and send you a direct booking link.\n"
        "You book yourself — fast and official.\n"
        "⚡ Slots disappear within minutes — act immediately.\n\n"
        "💡 After payment, just close the page — we'll handle everything automatically.\n\n"
        "💶 <b>Choose your plan:</b>\n"
        "⭐ <b>Best Value: 30 days — €19.99</b>\n"
        "   Automatic monitoring for 30 days. We notify you when a slot appears. Availability is not guaranteed.\n"
        "📅 7 days — €12.99\n"
    ...
    "de": (
        "🔎 <b>Termin Monitoring — {city}</b>\n\n"
        "📄 <b>{service}</b>\n\n"
        "Wir finden freie Termine und senden Ihnen den direkten Buchungslink.\n"
        "Sie buchen selbst — schnell und offiziell.\n"
        "⚡ Termine vergehen in Minuten — sofort handeln.\n\n"
        "💡 Nach der Zahlung einfach die Seite schließen — wir erledigen den Rest automatisch.\n\n"
        "💶 <b>Plan wählen:</b>\n"
        "⭐ <b>Beste Wahl: 30 Tage — €19,99</b>\n"
        "   Automatische Überwachung 30 Tage. Wir benachrichtigen Sie, wenn ein Termin verfügbar ist. Verfügbarkeit nicht garantiert.\n"
        "📅 7 Tage — €12,99\n"
    ...
    "pl": (
        "🔎 <b>Termin Monitoring — {city}</b>\n\n"
        "📄 <b>{service}</b>\n\n"
        "Szukamy wolnych terminów i wysyłamy bezpośredni link do rezerwacji.\n"
        "Rezerwujesz samodzielnie — szybko i oficjalnie.\n"
        "⚡ Terminy znikają w minuty — działaj natychmiast.\n\n"
        "💡 Po płatności po prostu zamknij stronę — zrobimy wszystko automatycznie.\n\n"
        "💶 <b>Wybierz plan:</b>\n"
        "⭐ <b>Najlepsza cena: 30 dni — €19,99</b>\n"
        "   Automatyczny monitoring przez 30 dni. Powiadomimy Cię, gdy pojawi się termin. Dostępność nie jest gwarantowana.\n"
        "📅 7 dni — €12,99\n"
    ...
    "tr": (
        "🔎 <b>Termin Monitoring — {city}</b>\n\n"
        "📄 <b>{service}</b>\n\n"
        "Boş randevuları buluyoruz ve doğrudan rezervasyon linki gönderiyoruz.\n"
        "Kendiniz rezervasyon yaparsınız — hızlı ve resmi.\n"
        "⚡ Randevular dakikalar içinde kayboluyor — hemen harekete geç.\n\n"
        "💡 Ödeme sonrası sayfayı kapatabilirsiniz — her şeyi otomatik hallederiz.\n\n"
        "💶 <b>Plan seçin:</b>\n"
        "⭐ <b>En iyi fiyat: 30 gün — €19,99</b>\n"
        "   30 gün otomatik izleme. Bir randevu açıldığında sizi bilgilendiririz. Uygunluk garanti değildir.\n"
        "📅 7 gün — €12,99\n"
    ...
    "ar": (
        "🔎 <b>Termin Monitoring — {city}</b>\n\n"
        "📄 <b>{service}</b>\n\n"
        "نبحث عن المواعيد الشاغرة ونرسل لك رابط الحجز المباشر.\n"
        "تحجز بنفسك — بسرعة ورسمياً.\n"
        "⚡ تختفي المواعيد خلال دقائق — تصرف فوراً.\n\n"
        "💡 بعد الدفع، أغلق الصفحة فقط — سنتولى كل شيء تلقائياً.\n\n"
        "💶 <b>اختر خطتك:</b>\n"
        "⭐ <b>أفضل قيمة: 30 يومًا — €19.99</b>\n"
        "   مراقبة تلقائية لمدة 30 يومًا. سنُعلمك عند ظهور موعد. التوفر غير مضمون.\n"
        "📅 7 أيام — €12.99\n"
...
_DOC_TYPE_LABELS = {
    ...
    "niederlassungserlaubnis": {
        "ua": "🏠 Niederlassungserlaubnis (постійне проживання)",
        "uk": "🏠 Niederlassungserlaubnis (постійне проживання)",
        "en": "🏠 Niederlassungserlaubnis (permanent residence)",
        "de": "🏠 Niederlassungserlaubnis (Daueraufenthaltsrecht)",
        "pl": "🏠 Niederlassungserlaubnis (pobyt stały)",
        "tr": "🏠 Niederlassungserlaubnis (süresiz oturma izni)",
        "ar": "🏠 Niederlassungserlaubnis (إقامة دائمة)",
    },
    "fuehrerschein": {
        "ua": "🚗 Führerschein (конвертація водійського посвідчення)",
        "uk": "🚗 Führerschein (конвертація водійського посвідчення)",
        "en": "🚗 Führerschein (driver's license conversion)",
        "de": "🚗 Führerschein (Fahrerlaubnisumschreibung)",
        "pl": "🚗 Führerschein (wymiana prawa jazdy)",
        "tr": "🚗 Führerschein (ehliyet dönüşümü)",
        "ar": "🚗 Führerschein (تحويل رخصة القيادة)",
    },
    "personalausweis": {
        "ua": "🪪 Personalausweis (посвідчення особи)",
        "uk": "🪪 Personalausweis (посвідчення особи)",
        "en": "🪪 Personalausweis (German ID card)",
        "de": "🪪 Personalausweis (Identitätsdokument)",
        "pl": "🪪 Personalausweis (dowód osobisty)",
        "tr": "🪪 Personalausweis (kimlik kartı)",
        "ar": "🪪 Personalausweis (بطاقة الهوية)",
    },
    "reisepass": {
        "ua": "🛂 Reisepass (закордонний паспорт)",
        "uk": "🛂 Reisepass (закордонний паспорт)",
        "en": "🛂 Reisepass (German passport)",
        "de": "🛂 Reisepass (Reisedokument)",
        "pl": "🛂 Reisepass (paszport)",
        "tr": "🛂 Reisepass (pasaport)",
        "ar": "🛂 Reisepass (جواز السفر الألماني)",
    },
}
...
_NO_SLOTS_WHY_TEXT = {
    ...
    "de": (
        ...
        "✓ Regelmäßige automatische Prüfung\n"
    ...
    "pl": (
        ...
        "✓ Regularne automatyczne sprawdzanie\n"
...
_PAYMENT_SUCCESS_RICH = {
    "uk": (
        ...
        "Ми регулярно перевіряємо наявність місць.\n"
    ...
    "en": (
        ...
        "📍 {city} → {authority}\n"
        "🕐 Started: {started_at}\n\n"
        "Regularly checking for available slots.\n"
    ...
    "tr": (
        ...
        "Düzenli olarak müsait randevu kontrol ediyoruz.\n"
    ...
    "ar": (
        ...
        "📍 {city} → {authority}\n"
        "🕐 بدأ في: {started_at}\n\n"
        "نتحقق بانتظام من المواعيد المتاحة.\n"
...
async def handle_cities(callback: types.CallbackQuery, state: FSMContext):
    ...
    If user has an active monitoring session, shows a warning asking them to confirm
    before stopping the existing session.  Only when no active session (or after
    confirmation) does the flow continue to the city-selection keyboard.
    """
    await callback.answer(cache_time=1)
    user_id = callback.from_user.id
    lang = _resolve_lang(user_id)
    ...
    # ── Guard: warn before stopping an active monitoring session ──────────────
    existing_session = get_polling_session(user_id)
    if existing_session:
        from backend.termin_texts import get_text as _get_text
        _active_city_raw = existing_session.city or ""
        _active_city_display = _CITY_DISPLAY_MAP.get(
            _active_city_raw, _active_city_raw.replace("_", " ").title()
        ) if _active_city_raw else "?"
        _title = _get_text("change_city_warning_title", lang)
        _body = _get_text("change_city_warning_body", lang, city=_active_city_display)
        _warning_text = f"<b>{_title}</b>\n\n{_body}"
        _confirm_label = _get_text("change_city_confirm", lang)
        _cancel_label = _get_text("change_city_cancel", lang)
        from aiogram.types import InlineKeyboardMarkup, InlineKeyboardButton
        _warn_kb = InlineKeyboardMarkup(row_width=1)
        _warn_kb.add(
            InlineKeyboardButton(_confirm_label, callback_data="termin_change_city_confirm"),
            InlineKeyboardButton(_cancel_label, callback_data="termin_change_city_cancel"),
        )
        logger.info(
            "CHANGE_CITY_WARNING_SHOWN | user=%s active_city=%s",
            user_id, _active_city_raw,
        )
        await callback.message.edit_text(_warning_text, parse_mode="HTML", reply_markup=_warn_kb)
        return
    # ── No active session: go straight to city selection ──────────────────────
...
async def handle_change_city_confirm(callback: types.CallbackQuery, state: FSMContext):
    """User confirmed they want to change city — stop existing session and open city picker."""
    await callback.answer(cache_time=1)
    user_id = callback.from_user.id
    lang = _resolve_lang(user_id)

    existing_session = get_polling_session(user_id)
    old_city = (existing_session.city or "") if existing_session else ""

    if existing_session:
        from utils.termin_checker import stop_polling as _stop_polling_confirm
        _stop_polling_confirm(user_id, reason="change_city_confirmed")
        logger.info(
            "TERMIN_OLD_SESSION_STOPPED | user=%s city=%s reason=change_city_confirmed",
            user_id, old_city,
        )

    from backend.termin_texts import get_text as _get_text_cc
    _stopped_msg = _get_text_cc("old_monitoring_stopped", lang)
    try:
        await callback.message.answer(_stopped_msg, parse_mode="HTML")
    except Exception:
        pass
...
async def handle_change_city_cancel(callback: types.CallbackQuery, state: FSMContext):
    """User cancelled city change — return to main termin menu."""
    await callback.answer(cache_time=1)
    user_id = callback.from_user.id
    lang = _resolve_lang(user_id)
    logger.info("CHANGE_CITY_CANCELLED | user=%s", user_id)
    # Return to the termin entry screen (same as going back to menu)
    try:
        await callback.message.edit_text(
            _build_termin_entry_text(lang),
            parse_mode="HTML",
    ...
    try:
        ...
        for order in orders:
            ...
            if not stored_url or not stored_url.startswith("https://"):
                # DB fallback: reload checkout URL persisted before last restart
                try:
                    from backend.termin_db import get_entitlement_checkout_url as _gecu
                    _db_url = _gecu(str(user_id))
                    if _db_url and _db_url.startswith("https://"):
                        stored_url = _db_url
                        _termin_checkout_sent[oid] = _db_url  # hydrate cache
                except Exception:
                    pass
            if not stored_url or not stored_url.startswith("https://"):
...
async def handle_notify_pay(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        logger.info("CITY_SELECTED | user=%s city=%s authority=%s flow=notify_pay",
                    user_id, user_city, user_authority)
        ...
        try:
            ...
            from utils.user_email import get_user_email as _get_ue1
            _email = _get_ue1(user_id)
            logger.info(
                "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=notify_pay",
                user_id, user_city, user_authority, _email or "—",
            )
            ...
            if result.success:
                ...
                try:
                    from backend.termin_db import save_entitlement_checkout_url as _secu1
                    _secu1(str(user_id), result.checkout_url)
                except Exception as _secu1_err:
                    logger.debug("save_entitlement_checkout_url failed (non-fatal): %s", _secu1_err)
...
async def handle_pay_for_reminders(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        logger.info("CITY_SELECTED | user=%s city=%s authority=%s flow=pay_for_reminders",
        ...
        try:
            ...
            stripe_h = get_stripe_handler()
            from utils.user_email import get_user_email as _get_ue2
            _email = _get_ue2(user_id)
            logger.info(
                "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=pay_for_reminders",
                user_id, city_code, authority_type, _email or "—",
            )
            result = await stripe_h.create_checkout_session(
                order_id=order_id,
                user_id=user_id,
            ...
            if result.success:
                ...
                _register_checkout_sent(order_id, result.checkout_url)
                try:
                    from backend.termin_db import save_entitlement_checkout_url as _secu2
                    _secu2(str(user_id), result.checkout_url)
                except Exception as _secu2_err:
                    logger.debug("save_entitlement_checkout_url failed (non-fatal): %s", _secu2_err)
                logger.info("STRIPE_DIRECT_OPEN order=%s url=%s", order_id, result.checkout_url)
                await callback.answer(cache_time=1)
                keyboard = InlineKeyboardMarkup(row_width=1)
                keyboard.add(InlineKeyboardButton(
...
_POLL_START_TEXT = {
    "ua": "🔍 <b>Моніторинг запущено</b>\n🔄 Ми регулярно перевіряємо наявність термінів. Сповістимо одразу, щойно з\u02bcявиться місце.",
    "uk": "🔍 <b>Моніторинг запущено</b>\n🔄 Ми регулярно перевіряємо наявність термінів. Сповістимо одразу, щойно з\u02bcявиться місце.",
    "en": "🔍 <b>Monitoring started</b>\n🔄 We regularly check for available slots. You'll be notified as soon as one appears.",
    "de": "🔍 <b>Überwachung gestartet</b>\n🔄 Wir prüfen regelmäßig nach freien Terminen. Sie werden benachrichtigt, sobald ein Termin frei wird.",
    "pl": "🔍 <b>Monitorowanie uruchomione</b>\n🔄 Regularnie sprawdzamy dostępne terminy. Powiadomimy Cię, gdy pojawi się wolne miejsce.",
...
def _reservation_minutes() -> int:
    try:
        from utils.termin_checker import RESERVATION_TIMEOUT_SEC as _rts
        return max(1, _rts // 60)
    except Exception:
        return 3
...
_RESERVATION_OFFER_TEXT = {
    "ua": (
        ...
        "⏳ У вас є кілька хвилин, щоб забронювати термін.\n\n"
    ...
    "en": (
        ...
        "⏳ You have a few minutes to book your appointment.\n\n"
    ...
    "de": (
        ...
        "⏳ Sie haben einige Minuten, um den Termin zu buchen.\n\n"
    ...
    "pl": (
        ...
        "⏳ Masz kilka minut, aby zarezerwować termin.\n\n"
    ...
    "tr": (
        ...
        "⏳ Randevuyu rezerve etmek için birkaç dakikanız var.\n\n"
...
_SLOT_FOUND_HEADER = {
    "uk": (
        "🔥 <b>Вільний слот знайдено!</b>\n\n"
        "🏛 {authority}\n"
        "📍 {city}\n"
        "{date_line}"
        "{time_line}"
        "⏱ Запис займе ~1 хв — слот може зникнути"
    ),
    "en": (
        "🔥 <b>Free slot found!</b>\n\n"
        "🏛 {authority}\n"
        ...
        "{date_line}"
        "{time_line}"
        "⏱ Booking takes ~1 min — slot may disappear fast"
    ),
    "de": (
        "🔥 <b>Freier Termin gefunden!</b>\n\n"
        "🏛 {authority}\n"
        "📍 {city}\n"
        "{date_line}"
        "{time_line}"
        "⏱ Buchung dauert ~1 Min — Termin kann schnell weg sein"
    ),
    "pl": (
        "🔥 <b>Wolny termin znaleziony!</b>\n\n"
        "🏛 {authority}\n"
        "📍 {city}\n"
        "{date_line}"
        "{time_line}"
        "⏱ Rezerwacja ~1 min — termin może szybko zniknąć"
    ),
    "tr": (
        "🔥 <b>Boş randevu bulundu!</b>\n\n"
        "🏛 {authority}\n"
        "📍 {city}\n"
        "{date_line}"
        "{time_line}"
        "⏱ Rezervasyon ~1 dk — randevu hızla kaybolabilir"
    ),
    "ar": (
        "🔥 <b>تم العثور على موعد شاغر!</b>\n\n"
        "🏛 {authority}\n"
        "📍 {city}\n"
        "{date_line}"
        "{time_line}"
        "⏱ الحجز ~دقيقة — قد يختفي الموعد بسرعة"
    ),
}
# ── Portal-type detection ─────────────────────────────────────────────────────
# Maps a normalised city key → booking portal family.
# Add new cities here without touching any handler logic.
_PORTAL_MAP: dict[str, str] = {
    "berlin":      "BERLIN",
    "koeln":       "TEVIS_LIVENESS",
    "cologne":     "TEVIS_LIVENESS",
    "frankfurt":   "TEVIS",
    "duesseldorf": "TEVIS",
    "dusseldorf":  "TEVIS",
    "dortmund":    "TEVIS_LIVENESS",
    "krefeld":     "TEVIS",
    "muenchen":    "MUENCHEN",
    "munich":      "MUENCHEN",
}
...
def _get_portal_type(city: str) -> str:
    """Return the booking-portal family for *city* (lowercase key)."""
    return _PORTAL_MAP.get((city or "").lower().strip(), "GENERIC")


# ── Pre-open booking instructions (shown BEFORE user clicks button) ───────────
# Conversational "site is opening" format. {service_step} is substituted at
# render-time with either ":\n   → <b>GermanServiceName</b>" or a translated
# generic fallback.  ua = alias of uk (validator requires both).
_PORTAL_INSTRUCTIONS: dict[str, dict[str, str]] = {
    "TEVIS": {
        "uk": (
            "👉 <b>Зараз відкриється офіційний сайт запису:</b>\n"
            "1. Натисніть «Akzeptieren»\n"
            "2. Послугу вже вибрано → вкажіть кількість осіб → «Weiter»\n"
            "3. Оберіть дату і час → підтвердіть"
        ),
        "ua": (
            "👉 <b>Зараз відкриється офіційний сайт запису:</b>\n"
            "1. Натисніть «Akzeptieren»\n"
        ...
        "en": (
            "👉 <b>The official booking site is opening:</b>\n"
            "1. Click «Akzeptieren» (accept cookies)\n"
            "2. Service already selected → enter number of persons → «Weiter»\n"
            "3. Pick a date & time → confirm"
        ),
        "de": (
            "👉 <b>Die offizielle Buchungsseite öffnet sich:</b>\n"
            "1. «Akzeptieren» klicken (Cookies)\n"
            "2. Dienst bereits ausgewählt → Personenzahl eingeben → «Weiter»\n"
            "3. Datum & Uhrzeit wählen → bestätigen"
        ),
        "pl": (
            "👉 <b>Oficjalna strona rezerwacji się otwiera:</b>\n"
            "1. Kliknij «Akzeptieren»\n"
            "2. Usługa już wybrana → podaj liczbę osób → «Weiter»\n"
            "3. Wybierz datę i godzinę → potwierdź"
        ),
        "tr": (
            "👉 <b>Resmi rezervasyon sitesi açılıyor:</b>\n"
            "1. «Akzeptieren» tıklayın\n"
            "2. Hizmet zaten seçili → kişi sayısını girin → «Weiter»\n"
            "3. Tarih ve saat seçin → onaylayın"
        ),
        "ar": (
            "👉 <b>الموقع الرسمي للحجز يفتح الآن:</b>\n"
            "1. انقر «Akzeptieren»\n"
            "2. الخدمة محددة مسبقًا → أدخل عدد الأشخاص → «Weiter»\n"
            "3. اختر التاريخ والوقت ← أكّد"
        ),
    },
    # TEVIS liveness-only cities (Köln, Dortmund) — user arrives at service-selection
    # step and must choose the service manually; "service already selected" does not apply.
    "TEVIS_LIVENESS": {
        "uk": (
            "👉 <b>Зараз відкриється офіційний сайт запису:</b>\n"
            "1. Натисніть «Akzeptieren»\n"
            "2. Виберіть потрібну послугу → вкажіть кількість осіб → «Weiter»\n"
            "3. Оберіть дату і час → підтвердіть"
        ),
        "ua": (
            "👉 <b>Зараз відкриється офіційний сайт запису:</b>\n"
        ...
        "en": (
            "👉 <b>The official booking site is opening:</b>\n"
            "1. Click «Akzeptieren» (accept cookies)\n"
            "2. Select the service you need → enter number of persons → «Weiter»\n"
            "3. Pick a date & time → confirm"
        ),
        "de": (
            "👉 <b>Die offizielle Buchungsseite öffnet sich:</b>\n"
            "1. «Akzeptieren» klicken (Cookies)\n"
            "2. Gewünschten Dienst auswählen → Personenzahl eingeben → «Weiter»\n"
            "3. Datum & Uhrzeit wählen → bestätigen"
        ),
        "pl": (
            "👉 <b>Oficjalna strona rezerwacji się otwiera:</b>\n"
            "1. Kliknij «Akzeptieren»\n"
            "2. Wybierz potrzebną usługę → podaj liczbę osób → «Weiter»\n"
            "3. Wybierz datę i godzinę → potwierdź"
        ),
        "tr": (
            "👉 <b>Resmi rezervasyon sitesi açılıyor:</b>\n"
            "1. «Akzeptieren» tıklayın\n"
            "2. İhtiyacınız olan hizmeti seçin → kişi sayısını girin → «Weiter»\n"
            "3. Tarih ve saat seçin → onaylayın"
        ),
        "ar": (
            "👉 <b>الموقع الرسمي للحجز يفتح الآن:</b>\n"
            "1. انقر «Akzeptieren»\n"
            "2. اختر الخدمة المطلوبة → أدخل عدد الأشخاص → «Weiter»\n"
            "3. اختر التاريخ والوقت ← أكّد"
        ),
    },
    "BERLIN": {
        "uk": (
            "👉 <b>Зараз відкриється офіційний сайт запису:</b>\n"
            "1. У списку знайдіть{service_step}\n"
            "2. Оберіть зручне відділення\n"
            "3. Оберіть дату і час\n"
            "4. Введіть дані → підтвердіть"
        ),
        "ua": (
            "👉 <b>Зараз відкриється офіційний сайт запису:</b>\n"
            "1. У списку знайдіть{service_step}\n"
        ...
        "en": (
            "👉 <b>The official booking site is opening:</b>\n"
            "1. Find in the list{service_step}\n"
            "2. Choose a convenient office\n"
            "3. Pick a date & time\n"
            "4. Enter your details → confirm"
        ),
        "de": (
            "👉 <b>Die offizielle Buchungsseite öffnet sich:</b>\n"
            "1. In der Liste finden{service_step}\n"
            "2. Passendes Bürgeramt wählen\n"
            "3. Datum & Uhrzeit wählen\n"
            "4. Kontaktdaten eingeben → bestätigen"
        ),
        "pl": (
            "👉 <b>Oficjalna strona rezerwacji się otwiera:</b>\n"
            "1. Na liście znajdź{service_step}\n"
            "2. Wybierz wygodny urząd\n"
            "3. Wybierz datę i godzinę\n"
            "4. Wpisz dane → potwierdź"
        ),
        "tr": (
            "👉 <b>Resmi rezervasyon sitesi açılıyor:</b>\n"
            "1. Listede bulun{service_step}\n"
            "2. Uygun ofisi seçin\n"
            "3. Tarih ve saat seçin\n"
            "4. Bilgilerinizi girin → onaylayın"
        ),
        "ar": (
            "👉 <b>الموقع الرسمي للحجز يفتح الآن:</b>\n"
            "1. ابحث في القائمة{service_step}\n"
            "2. اختر المكتب المناسب\n"
    ...
    "MUENCHEN": {
        "uk": (
            "👉 <b>Зараз відкриється офіційний сайт запису:</b>\n"
            "1. Оберіть відділення (Stadtbezirk)\n"
            "2. У списку знайдіть{service_step}\n"
            "3. Оберіть дату і час\n"
            "4. Введіть дані → підтвердіть"
        ),
        "ua": (
        ...
        "en": (
            "👉 <b>The official booking site is opening:</b>\n"
            "1. Select a district office (Stadtbezirk)\n"
            "2. Find in the list{service_step}\n"
            "3. Pick a date & time\n"
            "4. Enter your details → confirm"
        ),
        "de": (
            "👉 <b>Die offizielle Buchungsseite öffnet sich:</b>\n"
            "1. Stadtbezirk / Dienststelle wählen\n"
            "2. In der Liste finden{service_step}\n"
            "3. Datum & Uhrzeit wählen\n"
            "4. Kontaktdaten eingeben → bestätigen"
        ),
        "pl": (
            "👉 <b>Oficjalna strona rezerwacji się otwiera:</b>\n"
            "1. Wybierz dzielnicę / punkt (Stadtbezirk)\n"
            "2. Na liście znajdź{service_step}\n"
            "3. Wybierz datę i godzinę\n"
            "4. Wpisz dane → potwierdź"
        ),
        "tr": (
            "👉 <b>Resmi rezervasyon sitesi açılıyor:</b>\n"
            "1. Bölgeyi / ofisi seçin (Stadtbezirk)\n"
            "2. Listede bulun{service_step}\n"
            "3. Tarih ve saat seçin\n"
            "4. Bilgilerinizi girin → onaylayın"
        ),
        "ar": (
            "👉 <b>الموقع الرسمي للحجز يفتح الآن:</b>\n"
            "1. اختر المنطقة / المكتب (Stadtbezirk)\n"
            "2. ابحث في القائمة{service_step}\n"
            "3. اختر التاريخ والوقت\n"
            "4. أدخل بياناتك ← أكّد"
        ),
    },
...
# ── Cookie / consent banner hint ──────────────────────────────────────────────
# Many German portals show an "Akzeptieren" consent banner before the booking
# page is visible.  This one-liner prevents user confusion.
_COOKIE_HINT: dict[str, str] = {
    "uk": "⚠️ Якщо бачите «Akzeptieren» — натисніть його, щоб продовжити.",
    "ua": "⚠️ Якщо бачите «Akzeptieren» — натисніть його, щоб продовжити.",
    "en": "⚠️ If you see «Akzeptieren» (Accept) — click it to continue.",
    "de": "⚠️ Wenn Sie «Akzeptieren» sehen — klicken Sie darauf, um fortzufahren.",
    "pl": "⚠️ Jeśli widzisz «Akzeptieren» — kliknij, aby kontynuować.",
    "tr": "⚠️ «Akzeptieren» görürseniz — devam etmek için tıklayın.",
    "ar": "⚠️ إذا رأيت «Akzeptieren» — انقر عليه للمتابعة.",
}

# ── Service label map (authority slug → exact German name shown on the portal) ─
# The German term is language-invariant — it always appears as-is on the portal.
# Displayed inline inside the portal instructions as "   → <b>Label</b>".
_SERVICE_LABEL: dict[str, str] = {
    "buergeramt":           "Anmeldung einer Wohnung",
    "auslaenderbehoerde":   "Aufenthaltserlaubnis / Aufenthaltstitel",
    "niederlassungserlaubnis": "Niederlassungserlaubnis",
    "jobcenter":            "Bürgergeld / Arbeitslosengeld",
    "familienkasse":        "Kindergeld",
    "fuehrerschein":        "Fahrerlaubnisumschreibung",
...
# Fallback text for the {service_step} placeholder when authority is unknown.
# Used inline, so phrasing flows naturally after "… знайдіть …" / "… find …".
_SERVICE_STEP_FALLBACK: dict[str, str] = {
    "uk": " потрібну послугу",
    "ua": " потрібну послугу",
    "en": " your service",
    "de": " Ihre Dienstleistung",
    "pl": " usługę",
    "tr": " hizmeti",
    "ar": " الخدمة المطلوبة",
}

# Localised "SELECT:" call-to-action shown inline before the German service name.
_SELECT_LABEL: dict[str, str] = {
    "uk": "👉 ОБЕРІТЬ:",
    "ua": "👉 ОБЕРІТЬ:",
    "en": "👉 SELECT:",
    "de": "👉 WÄHLEN:",
...
# One-liner that removes timing anxiety — shown once at the end of instructions.
_QUICK_LINE: dict[str, str] = {
    "uk": "⏱ Це займе ~1 хвилину",
    "ua": "⏱ Це займе ~1 хвилину",
    "en": "⏱ This takes ~1 minute",
    "de": "⏱ Das dauert ~1 Minute",
    "pl": "⏱ To zajmie ~1 minutę",
    "tr": "⏱ Bu ~1 dakika sürer",
    "ar": "⏱ هذا يستغرق ~دقيقة واحدة",
}


def _build_dynamic_instructions(portal: str, authority: str, lang: str) -> str:
    """Build the full pre-open instruction block injected into the slot-found message.

    Combines:
      1. Portal-specific step-by-step template (TEVIS / BERLIN / MUENCHEN / GENERIC)
         with a {service_step} placeholder substituted inline.
      2. "Takes ~1 min" reassurance line.
      3. Cookie / consent-banner reminder.

    When the authority slug is known the placeholder becomes:
        ":\n👉 SELECT: <b>GermanServiceName</b>"
    otherwise a generic translated fallback so the sentence still reads naturally.
    Never raises.
    """
    german_label = _SERVICE_LABEL.get((authority or "").lower().strip(), "")
    if german_label:
        select_lbl = _lang_text(_SELECT_LABEL, lang)
        service_step = f":\n{select_lbl} <b>{german_label}</b>"
    else:
        service_step = _lang_text(_SERVICE_STEP_FALLBACK, lang)

    template = _lang_text(
        _PORTAL_INSTRUCTIONS.get(portal, _PORTAL_INSTRUCTIONS["GENERIC"]), lang
    )
    try:
        base = template.format(service_step=service_step)
    except (KeyError, ValueError):
        base = template

    quick = _lang_text(_QUICK_LINE, lang)
    cookie = _lang_text(_COOKIE_HINT, lang)
    return f"{base}\n\n{quick}\n{cookie}"
...
_CONFIRM_REMIND_TEXT = {
    "ua": (
        "🎉 <b>Ти записаний!</b>\n\n"
        "Це те, чого ти довго чекав — і ти це зробив.\n"
        "Моніторинг завершено. Бажаємо успішного прийому! 🍀\n\n"
        "Нагадати про зустріч за 24 години до неї?"
    ),
    "uk": (
        "🎉 <b>Ти записаний!</b>\n\n"
        "Це те, чого ти довго чекав — і ти це зробив.\n"
    ...
    "en": (
        "🎉 <b>You're booked!</b>\n\n"
        "This is what you've been waiting for — and you made it happen.\n"
        "Monitoring complete. Wishing you a smooth appointment! 🍀\n\n"
        "Should we remind you 24 hours before your appointment?"
    ),
    "de": (
        "🎉 <b>Du hast einen Termin!</b>\n\n"
        "Darauf hast du gewartet — und jetzt ist es geschafft.\n"
        "Monitoring abgeschlossen. Wir wünschen dir einen reibungslosen Termin! 🍀\n\n"
        "Soll ich Sie 24 Stunden vorher erinnern?"
    ),
    "pl": (
        "🎉 <b>Masz termin!</b>\n\n"
        "Na to czekałeś — i udało się.\n"
        "Monitoring zakończony. Życzymy pomyślnej wizyty! 🍀\n\n"
        "Czy mamy przypomnieć Ci 24 godziny przed wizytą?"
    ),
    "tr": (
        "🎉 <b>Randevun alındı!</b>\n\n"
        "Beklediğin şey buydu — ve başardın.\n"
        "İzleme tamamlandı. Başarılı bir randevu diliyoruz! 🍀\n\n"
        "Randevunuzdan 24 saat önce hatırlatmamızı ister misiniz?"
    ),
    "ar": (
        "🎉 <b>تم تسجيلك في الموعد!</b>\n\n"
        "هذا ما كنت تنتظره — وقد نجحت.\n"
        "اكتملت المراقبة. نتمنى لك موعدًا ناجحًا! 🍀\n\n"
...
_PAYMENT_SUCCESS_TEXT = {
    "ua": "✅ <b>Оплата підтверджена!</b>\n\n⏳ Активуємо моніторинг — деталі надійдуть наступним повідомленням.",
    "uk": "✅ <b>Оплата підтверджена!</b>\n\n⏳ Активуємо моніторинг — деталі надійдуть наступним повідомленням.",
    "en": "✅ <b>Payment confirmed!</b>\n\n⏳ Activating monitoring — details will follow in the next message.",
    "de": "✅ <b>Zahlung bestätigt!</b>\n\n⏳ Überwachung wird aktiviert — Details folgen in der nächsten Nachricht.",
    "pl": "✅ <b>Płatność potwierdzona!</b>\n\n⏳ Aktywujemy monitorowanie — szczegóły w następnej wiadomości.",
    "tr": "✅ <b>Ödeme onaylandı!</b>\n\n⏳ İzleme etkinleştiriliyor — ayrıntılar bir sonraki mesajda gelecek.",
    "ar": "✅ <b>تم تأكيد الدفع!</b>\n\n⏳ جارٍ تفعيل المراقبة — التفاصيل ستصل في الرسالة التالية.",
}
...
async def _create_termin_checkout(
    user_id: int, city: str, price: float, lang: str, authority: str = "",
):
    ...
    try:
        from utils.helpers import get_db
        from handlers.stripe_handler import get_stripe_handler
        from utils.user_email import get_user_email as _get_ue3
        ...
        stripe_h = get_stripe_handler()
        _email = _get_ue3(user_id)
        logger.info(
            "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=termin_reservation",
            user_id, city, authority, _email or "—",
        )
        result = await stripe_h.create_checkout_session(
            order_id=order_id,
            user_id=user_id,
...
async def finalize_termin_webhook_payment(bot_instance, user_id: int, metadata: dict) -> bool:
    ...
    try:
        ...
        log_funnel(
            ...
            plan=str(metadata.get("monitor") or metadata.get("plan") or "reservation"),
        )
...
async def handle_termin_start_poll(callback: types.CallbackQuery, state: FSMContext):
    ...
    if is_polling(user_id) or is_reserved(user_id):
        ...
        stop_polling(user_id, reason="new_payment_different_city")
        logger.info(
        ...
        if text.startswith("\u23f3"):  # ⏳ reservation expired signal (U+23F3 hourglass)
            ...
            try:
                ...
                _resume_kb2.add(InlineKeyboardButton(
                    _lang_text(_MONITOR_STATUS_BTN, _l_send),
    ...
    async def _on_reserved(cid: int, rlang: str) -> None:
        ...
        _is_liveness = _slot.get("liveness_only", False)
        if _is_liveness:
            from utils.termin_checker import _MSG_FOUND_LIVENESS as _MFL
            _success_header = (
                f"{_lang_text(_MFL, rlang)}\n\n"
                f"🏛 {_auth_display}\n"
                f"📍 {_city_display}"
            )
        else:
        ...
        # Debounce: skip duplicate slot notification within 60 seconds
        _now_utc = datetime.now(timezone.utc)
        try:
            from backend.termin_db import get_last_slot_found_at as _glsfa_db
            _last_notified = _glsfa_db(str(cid))
            if _last_notified:
                _ln_dt = datetime.fromisoformat(_last_notified)
                if _ln_dt.tzinfo is None:
        ...
        try:
            ...
            _slsfa(str(cid))
        except Exception as _slsfa_err:
            logger.debug("set_last_slot_found_at failed (non-fatal): %s", _slsfa_err)
    ...
    async def _on_slot_found(cid: int, flang: str, slot: dict) -> None:
        ...
        logger.info("TELEGRAM_ALERT_SOUND_ON | user=%s city=%s type=found", cid, city)
        await bot_instance.send_message(cid, found_msg, reply_markup=upsell_kb, disable_notification=False)
...
async def handle_termin_stop_poll(callback: types.CallbackQuery, state: FSMContext):
    ...
    # Persist the stopped state so /start gate does not re-show "active monitoring".
    # stop_polling() only cancels the in-memory asyncio task; without this DB update
    # is_termin_entitled() would still return True and the UX gate would incorrectly
    # display "🟢 активний" on the next /start or /my.
    try:
        from backend.termin_db import get_connection as _get_conn_stop
        with _get_conn_stop() as _conn_stop:
            _conn_stop.execute(
                "UPDATE termin_entitlements SET active=0 WHERE user_id=? AND active=1",
                (str(user_id),),
            )
            _conn_stop.commit()
    except Exception:
        logger.exception("TERMIN_STOP_DB_UPDATE_FAILED | user=%s", user_id)
...
async def handle_termin_resume_search(callback: types.CallbackQuery, state: FSMContext):
    ...
    if session and session.status == TerminStatus.PAUSED_AFTER_FOUND:
        ...
        if resumed:
            ...
            # Show the full status screen immediately so user sees active monitoring UI
    ...
    if session is not None:
        ...
        # Also show status screen so user can see current monitoring state
        await handle_termin_status(callback, state)
        return True
...
async def handle_termin_conflict_switch(callback: types.CallbackQuery, state: FSMContext):
    ...
    _stop(user_id, reason="conflict_switch_city")
...
async def handle_termin_proceed_payment(callback: types.CallbackQuery, state: FSMContext):
    ...
    # ── Entitlement guard — block repayment for active 7day/30day plans ──
    if is_termin_entitled(str(user_id)):
        logger.info(
            "TERMIN_ACCESS_CHECK | user=%s source_handler=proceed_payment entitled=True blocked_repayment=True",
            user_id,
        )
        _ALREADY_ENTITLED_MSG = {
            "uk": "✅ У вас уже активний Termin-моніторинг. Повторна оплата не потрібна.",
            "ua": "✅ У вас уже активний Termin-моніторинг. Повторна оплата не потрібна.",
            "en": "✅ You already have active Termin monitoring. No additional payment required.",
            "de": "✅ Sie haben bereits aktives Termin-Monitoring. Keine weitere Zahlung erforderlich.",
            "pl": "✅ Masz już aktywny monitoring Termin. Dodatkowa płatność nie jest wymagana.",
            "tr": "✅ Zaten aktif Termin izlemeniz var. Ek ödeme gerekmez.",
            "ar": "✅ لديك بالفعل مراقبة Termin نشطة. لا حاجة لدفع إضافي.",
        }
        try:
            await callback.message.answer(_lang_text(_ALREADY_ENTITLED_MSG, lang))
        except Exception:
            pass
        return
    logger.info(
        "TERMIN_ACCESS_CHECK | user=%s source_handler=proceed_payment entitled=False continue_payment=True",
        user_id,
    )
...
# ──────────────────────────────────────────────────────────────
_monitor_expiry_registry: dict = {}   # telegram_id (int) → ISO expiry datetime
_expiry_warning_sent: set = set()     # telegram_id (str) — already sent warning (str for compound keys)
_slot_found_registry: dict = {}       # telegram_id (int) → ISO datetime when slot was found
...
# ==================== Startup Hydration ====================
def restore_active_termin_sessions() -> None:
    """Hydrate in-memory registries from DB. Called ONCE from bot.py on startup."""
    try:
        from backend.termin_db import get_active_monitoring_expiry as _gme
        for _tid, _exp in _gme().items():
            _monitor_expiry_registry[int(_tid)] = _exp
        logger.info(
            "REGISTRY_RESTORED_FROM_DB | monitor_expiry=%d entries",
            len(_monitor_expiry_registry),
        )
    except Exception as _hme_err:
        logger.warning("REGISTRY_RESTORE_EXPIRY_FAIL: %s", _hme_err)

    try:
        from backend.termin_db import get_slot_found_entries as _gsfe
        for _tid, _ts in _gsfe().items():
            _slot_found_registry[int(_tid)] = _ts
        logger.info(
            "REGISTRY_RESTORED_FROM_DB | slot_found=%d entries",
            len(_slot_found_registry),
        )
    except Exception as _hsf_err:
        logger.warning("REGISTRY_RESTORE_SLOT_FOUND_FAIL: %s", _hsf_err)
...
async def process_reminders(bot: Bot):
    ...
    for reminder in reminders:
        ...
        booking_url = (
            ...
            or _CITY_PORTAL_FALLBACKS.get(_city_code.lower())
            or _CITY_BOOKING_PORTALS.get(_city_code.lower())
            or "https://www.germany.info/us-de/service/termine/termin-vereinbarung/2530996"
        )
        logger.info(
            "BOOKING_URL_SOURCE | user=%s city=%s authority=%s url=%s source=%s",
            reminder.get('telegram_id', '?'), _city_code,
            reminder.get('authority_type', '—'),
            booking_url,
            "reminder_db" if reminder.get('booking_url') else "portal_fallback",
        )
    ...
    for _tid, _expires_iso in list(_monitor_expiry_registry.items()):
        try:
            ...
            if now >= _expires_dt:
                ...
                _expiry_warning_sent.discard(str(_tid))
                continue
            ...
            if str(_tid) in _expiry_warning_sent:
                continue  # Already sent warning for this monitoring period

            _exp_user = get_user(str(_tid))
            if not _exp_user:
                continue
            ...
            _expiry_warning_sent.add(str(_tid))
    ...
    for _uid_str, _expiry_iso in list(_monitor_expiry_registry.items()):
        ...
        if _nudge_key in _expiry_warning_sent:
            continue
        try:
            _uid_int = _uid_str  # key is already int after PART-1 normalisation
            ...
            if _hours_since < 2:
                continue  # Too early
            _lang_nudge = get_user(str(_uid_str)).get('language', 'en') if get_user(str(_uid_str)) else 'en'
            _P2_NUDGE = {
    ...
    for _uid_str, _found_iso in list(_slot_found_registry.items()):
        ...
        try:
            ...
            if _days_since < 3:
                continue
            _uid_int = _uid_str  # key is already int after PART-1 normalisation
            _fu_user = get_user(str(_uid_str))
...
async def handle_termin_from_pdf(callback: types.CallbackQuery, state: FSMContext):
    ...
    lang = _resolve_lang(user_id)
    data = await state.get_data()
    _termin_city_fs = (data.get("termin_city") or "").strip()
    _source_doc_fs = data.get("source_doc")
    if getattr(callback, "data", None) == RETENTION_TERMIN_CB:
        log_funnel(
            "RETENTION_CLICK",
            user_id,
            doc_type=_source_doc_fs,
            lang=lang,
            city=_termin_city_fs or None,
            **{"type": "termin"},
        )
    else:
        log_funnel(
            "POST_PAYMENT_UPSELL_CLICK",
            user_id,
            doc_type=_source_doc_fs,
            lang=lang,
            city=_termin_city_fs or None,
...
async def handle_pay_termin_pdf(callback: types.CallbackQuery, state: FSMContext):
    ...
    city_code = _resolve_city_code(data.get("termin_city", "")) or ""
    source_doc = data.get("source_doc", "")

    if not city_code:
        logger.error(
            "CITY_SELECTED_MISSING | user=%s source=pay_termin_pdf — "
            "city absent from FSM state; user must select city before payment",
            user_id,
        )

    logger.info(
        "CITY_SELECTED | user=%s city=%r source=pay_termin_pdf source_doc=%s lang=%s",
...
_TERMIN_7DAY_PRICE  = 12.99
_TERMIN_30DAY_PRICE = 19.99
_FAMILY_PRICE = 4.99
...
# Cities where only liveness probing is supported (no automatic slot detection).
_MUENCHEN_CITIES: frozenset = frozenset({"muenchen", "münchen", "munich"})

# Shown on the price screen for liveness-only cities (e.g. Dortmund).
...
# München-specific pre-payment disclaimer — replaces the generic liveness note.
# Automatic slot detection is confirmed NOT available for München.
_MUENCHEN_MANUAL_NOTE = {
    "ua": (
        "⚠️ <b>München — режим порталу-асистента (ручний запис).</b>\n"
        "Автоматичне виявлення слотів для Мюнхена недоступне — портал вимагає захист від ботів.\n"
        "Бот підтверджує що портал відкритий та надає офіційне посилання й інструкцію.\n"
        "Перевірку наявності слотів та запис виконуєте самостійно на офіційному порталі."
    ),
    "uk": (
        "⚠️ <b>München — режим порталу-асистента (ручний запис).</b>\n"
        "Автоматичне виявлення слотів для Мюнхена недоступне — портал вимагає захист від ботів.\n"
    ...
    "en": (
        "⚠️ <b>München — portal assistant mode (manual booking).</b>\n"
        "Automatic slot detection is not available for München — the portal requires anti-bot protection.\n"
        "The bot confirms the portal is reachable and provides the official link and instructions.\n"
        "You must check for available slots and book your appointment manually on the official portal."
    ),
    "de": (
        "⚠️ <b>München — Portal-Assistent-Modus (manuelle Buchung).</b>\n"
        "Automatische Terminsuche ist für München nicht verfügbar — das Portal hat einen Bot-Schutz.\n"
        "Der Bot bestätigt, dass das Portal erreichbar ist, und liefert Link und Anleitung.\n"
        "Freie Termine und Buchung erfolgen manuell über das offizielle Portal."
    ),
    "pl": (
        "⚠️ <b>München — tryb asystenta portalu (ręczna rezerwacja).</b>\n"
        "Automatyczne wykrywanie slotów dla Monachium jest niedostępne — portal wymaga ochrony przed botami.\n"
        "Bot potwierdza dostępność portalu i dostarcza link oraz instrukcje.\n"
        "Sprawdzanie wolnych terminów i rezerwacji wykonujesz samodzielnie na oficjalnym portalu."
    ),
    "tr": (
        "⚠️ <b>München — portal asistanı modu (manuel rezervasyon).</b>\n"
        "München için otomatik randevu tespiti mevcut değil — portal bot koruması gerektiriyor.\n"
        "Bot, portalın erişilebilir olduğunu doğrular ve resmi bağlantıyı ve talimatları sağlar.\n"
        "Uygun randevuları kontrol etmek ve rezervasyon yapmak resmi portalda kendiniz yapılır."
    ),
    "ar": (
        "⚠️ <b>München — وضع مساعد البوابة (حجز يدوي).</b>\n"
        "الكشف التلقائي عن المواعيد غير متاح في مونيخ — البوابة تتطلب حماية من البوتات.\n"
        "يؤكد البوت إمكانية الوصول إلى البوابة ويوفر الرابط الرسمي والتعليمات.\n"
        "يجب عليك التحقق من المواعيد المتاحة وحجزها يدويًا عبر البوابة الرسمية."
    ),
}

# München — live status block texts (replaces "Monitoring active / Checking slots now")
_MUENCHEN_LIVE_HDR = {
    "uk": "Портал-асистент активний",
    "en": "Portal assistant active",
    "de": "Portal-Assistent aktiv",
    "pl": "Asystent portalu aktywny",
    "tr": "Portal asistanı aktif",
    "ar": "مساعد البوابة نشط",
}
_MUENCHEN_LIVE_BODY = {
    "uk": "🔗 Перевіряйте наявність слотів та записуйтесь вручну на офіційному порталі",
    "en": "🔗 Check for available slots and book manually on the official portal",
    "de": "🔗 Freie Termine prüfen und manuell über das offizielle Portal buchen",
    "pl": "🔗 Sprawdź wolne terminy i zarezerwuj ręcznie na oficjalnym portalu",
    "tr": "🔗 Resmi portalda uygun randevuları kontrol edin ve manuel olarak rezervasyon yapın",
    "ar": "🔗 تحقق من المواعيد المتاحة واحجز يدويًا عبر البوابة الرسمية",
}
...
async def handle_termin_monitor_pay(callback: types.CallbackQuery, state: FSMContext):
    ...
    # ── München override: manual portal mode — no automatic slot detection ─────
    # Replace the generic "checking every few seconds" clarity/value blocks with
    # accurate portal-assistant descriptions before the user pays.
    if city_code in _MUENCHEN_CITIES:
        _clarity_block = {
            "ua": (
                f"📍 Місто: <b>{city_display}</b>\n"
                f"🏢 Служба: <b>{_auth_name}</b>\n"
                "🔗 Режим: <b>Портал-асистент (ручний запис)</b>\n\n"
                "Автоматичне виявлення слотів недоступне.\n"
                "Бот надає офіційне посилання та інструкцію для ручного запису."
            ),
            "uk": (
                f"📍 Місто: <b>{city_display}</b>\n"
                f"🏢 Служба: <b>{_auth_name}</b>\n"
            ...
            "en": (
                f"📍 City: <b>{city_display}</b>\n"
                f"🏢 Service: <b>{_auth_name}</b>\n"
                "🔗 Mode: <b>Portal assistant (manual booking)</b>\n\n"
                "Automatic slot detection is not available.\n"
                "The bot provides the official link and step-by-step booking instructions."
            ),
            "de": (
                f"📍 Stadt: <b>{city_display}</b>\n"
                f"🏢 Dienst: <b>{_auth_name}</b>\n"
                "🔗 Modus: <b>Portal-Assistent (manuelle Buchung)</b>\n\n"
                "Automatische Terminsuche nicht verfügbar.\n"
                "Der Bot liefert den offiziellen Link und eine schrittweise Anleitung."
            ),
            "pl": (
                f"📍 Miasto: <b>{city_display}</b>\n"
                f"🏢 Usługa: <b>{_auth_name}</b>\n"
                "🔗 Tryb: <b>Asystent portalu (ręczna rezerwacja)</b>\n\n"
                "Automatyczne wykrywanie slotów niedostępne.\n"
                "Bot dostarcza oficjalny link i instrukcję krok po kroku."
            ),
            "tr": (
                f"📍 Şehir: <b>{city_display}</b>\n"
                f"🏢 Hizmet: <b>{_auth_name}</b>\n"
                "🔗 Mod: <b>Portal asistanı (manuel rezervasyon)</b>\n\n"
                "Otomatik randevu tespiti mevcut değil.\n"
                "Bot, resmi bağlantıyı ve adım adım talimatları sağlar."
            ),
            "ar": (
                f"📍 المدينة: <b>{city_display}</b>\n"
                f"🏢 الخدمة: <b>{_auth_name}</b>\n"
                "🔗 الوضع: <b>مساعد البوابة (حجز يدوي)</b>\n\n"
                "الكشف التلقائي عن المواعيد غير متاح.\n"
                "يوفر البوت الرابط الرسمي وتعليمات الحجز خطوة بخطوة."
            ),
        }.get(lang, (
            f"📍 City: <b>{city_display}</b>\n"
            f"🏢 Service: <b>{_auth_name}</b>\n"
        ...
        value_prop = {
            "ua": (
                "🗺 <b>Що ви отримуєте:</b>\n"
                "• Офіційне посилання для запису в Мюнхені\n"
                "• Покрокова інструкція проходження порталу\n"
                "• Нагадування про актуальний час появи нових слотів\n"
                "  (Пн–Пт 7–8 та 9–11 ранку)"
            ),
            "uk": (
                "🗺 <b>Що ви отримуєте:</b>\n"
                "• Офіційне посилання для запису в Мюнхені\n"
            ...
            "en": (
                "🗺 <b>What you get:</b>\n"
                "• Official München booking portal link\n"
                "• Step-by-step portal guide\n"
                "• Reminder about when new slots are released\n"
                "  (Mon–Fri 7–8 AM and 9–11 AM)"
            ),
            "de": (
                "🗺 <b>Was Sie erhalten:</b>\n"
                "• Offizieller München-Buchungsportal-Link\n"
                "• Schritt-für-Schritt-Anleitung\n"
                "• Hinweis zum Freischaltungszeitplan\n"
                "  (Mo–Fr 7–8 und 9–11 Uhr)"
            ),
            "pl": (
                "🗺 <b>Co otrzymujesz:</b>\n"
                "• Oficjalny link do portalu rezerwacji w Monachium\n"
                "• Przewodnik krok po kroku\n"
                "• Przypomnienie o harmonogramie publikacji slotów\n"
                "  (Pn–Pt 7–8 i 9–11 rano)"
            ),
            "tr": (
                "🗺 <b>Ne alırsınız:</b>\n"
                "• Resmi München rezervasyon portalı bağlantısı\n"
                "• Adım adım portal kılavuzu\n"
                "• Yeni randevu yayınlama zamanları hatırlatması\n"
                "  (Pzt–Cum 7–8 ve 9–11)"
            ),
            "ar": (
                "🗺 <b>ما ستحصل عليه:</b>\n"
                "• رابط بوابة الحجز الرسمية في مونيخ\n"
                "• دليل البوابة خطوة بخطوة\n"
                "• تذكير بمواعيد إصدار المواعيد الجديدة\n"
                "  (الاثنين–الجمعة 7–8 صباحًا و9–11 صباحًا)"
            ),
        }.get(lang, (
            "🗺 <b>What you get:</b>\n"
            "• Official München booking portal link\n"
    ...
    if city_code in _MUENCHEN_CITIES:
        price_text += "\n\n" + _lang_text(_MUENCHEN_MANUAL_NOTE, lang)
    elif city_code == "dortmund":
        price_text += "\n\n" + _lang_text(_TERMIN_LIVENESS_NOTE, lang)

    # Termin-only: one short disclaimer before Stripe (same copy as bundle teaser).
    price_text += "\n\n" + get_termin_positioning_short_html(lang)

    kb = InlineKeyboardMarkup(row_width=1)
    kb.add(InlineKeyboardButton(
        {
            "ua": f"⭐ Найкраща ціна: 30 днів — €{_TERMIN_30DAY_PRICE:.2f}",
            "uk": f"⭐ Найкраща ціна: 30 днів — €{_TERMIN_30DAY_PRICE:.2f}",
            "en": f"⭐ Best Value: 30 days — €{_TERMIN_30DAY_PRICE:.2f}",
            "de": f"⭐ Beste Wahl: 30 Tage — €{_TERMIN_30DAY_PRICE:.2f}",
            "pl": f"⭐ Najlepsza cena: 30 dni — €{_TERMIN_30DAY_PRICE:.2f}",
            "tr": f"⭐ En iyi fiyat: 30 gün — €{_TERMIN_30DAY_PRICE:.2f}",
            "ar": f"⭐ أفضل قيمة: 30 يومًا — €{_TERMIN_30DAY_PRICE:.2f}",
        }.get(lang, f"⭐ Best Value: 30 days — €{_TERMIN_30DAY_PRICE:.2f}"),
        callback_data=f"termin_monitor_confirm_30day_{city_code}",
    ))
    kb.add(InlineKeyboardButton(
        {
            "ua": f"📅 7 днів — €{_TERMIN_7DAY_PRICE:.2f}",
            "uk": f"📅 7 днів — €{_TERMIN_7DAY_PRICE:.2f}",
            "en": f"📅 7 days — €{_TERMIN_7DAY_PRICE:.2f}",
            "de": f"📅 7 Tage — €{_TERMIN_7DAY_PRICE:.2f}",
            "pl": f"📅 7 dni — €{_TERMIN_7DAY_PRICE:.2f}",
            "tr": f"📅 7 gün — €{_TERMIN_7DAY_PRICE:.2f}",
            "ar": f"📅 7 أيام — €{_TERMIN_7DAY_PRICE:.2f}",
        }.get(lang, f"📅 7 days — €{_TERMIN_7DAY_PRICE:.2f}"),
...
async def handle_termin_monitor_confirm(callback: types.CallbackQuery, state: FSMContext):
    ...
    fsm_data = await state.get_data()
    # source_doc: FSM → DB last_doc_type fallback (handles FSM loss after restart)
    _db_row_24h = get_user(str(user_id)) or {}
    source_doc = (
        fsm_data.get("source_doc")
        or fsm_data.get("doc_type")
        or _db_row_24h.get("last_doc_type")
        or ""
    )
    if not source_doc:
        logger.warning(
            "SOURCE_DOC_MISSING | user=%s city=%s — FSM lost, using price default %.2f",
            user_id, city_code, _TERMIN_PRICE_DEFAULT,
        )
    # Resolve authority: FSM → DB users table → DOC_AUTHORITY_MAP fallback
    authority_for_meta = (
        fsm_data.get("authority_type")
        or fsm_data.get("termin_authority_type")
        or _db_row_24h.get("authority") or ""
        or DOC_AUTHORITY_MAP.get(source_doc or "", "buergeramt")
    )
    price = _get_termin_price(source_doc)

    logger.info(
        "WEBHOOK_METADATA_PREPARED | user=%s city=%s authority=%s source_doc=%s price=%.2f",
        user_id, city_code, authority_for_meta, source_doc, price,
    )
    ...
    try:
        ...
        # Idempotency: reuse existing pending checkout if within TTL
        _idem_order = _find_reusable_termin_order(user_id, "termin_monitor_24h")
        if _idem_order and _idem_order.get("stripe_session_id"):
            _idem_oid = _idem_order.get("id") or _idem_order.get("order_id")
            _idem_url = _termin_checkout_sent.get(_idem_oid, "")
            if not _idem_url:
                try:
                    from backend.termin_db import get_entitlement_checkout_url as _gecu_24h
                    _idem_url = _gecu_24h(str(user_id))
                except Exception:
                    pass
            if _idem_url and _idem_url.startswith("https://"):
                logger.info("CHECKOUT_REUSED_24H | user=%s order=%s", user_id, _idem_oid)
                _idem_kb = InlineKeyboardMarkup(row_width=1)
                _idem_kb.add(InlineKeyboardButton(
                    _lang_text(_STRIPE_OPEN_BTN, lang).format(price=f"{price:.2f}"),
                    url=_idem_url,
                ))
                await callback.message.answer(
                    _lang_text(_STRIPE_REDIRECT_TEXT, lang),
                    reply_markup=_idem_kb,
                    disable_web_page_preview=True,
                )
                return
        ...
        from utils.user_email import get_user_email as _get_ue4
        _email = _get_ue4(user_id)
        logger.info(
            "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=24h",
            user_id, city_code, authority_for_meta, _email or "—",
        )
        ...
        if result.success:
            ...
            db.update_order_status(order_id, OrderStatus.PENDING, stripe_session_id=result.session_id)
            logger.info(
                "STRIPE_CHECKOUT_CREATED | user_id=%s order_id=%s plan=24h city=%s authority=%s success_url=%s",
                user_id, order_id, city_code, authority_for_meta, success_url,
            )
            logger.info(
            ...
            _monitor_expiry_registry[int(user_id)] = (
                datetime.now(timezone.utc) + timedelta(hours=24)
            ).isoformat()
            _expiry_warning_sent.discard(str(user_id))
            logger.info("TERMIN_EXPIRY_REGISTERED | user=%s", user_id)
            # Persist checkout URL so it survives restart (DB fallback in _find_reusable_termin_order)
            try:
                from backend.termin_db import save_entitlement_checkout_url as _secu3
                _secu3(str(user_id), result.checkout_url)
            except Exception as _secu3_err:
                logger.debug("save_entitlement_checkout_url failed (non-fatal): %s", _secu3_err)
            ...
            # Acknowledge the callback without opening a URL — the InlineKeyboardButton
            # above opens Stripe in the external browser where t.me deep-links work correctly.
            try:
                await callback.answer(cache_time=1)
            except Exception:
                pass
...
async def handle_termin_monitor_confirm_7day(callback: types.CallbackQuery, state: FSMContext):
    """Create Stripe Checkout for 7-day Extended monitoring plan (€12.99)."""
    await callback.answer(cache_time=1)
    ...
    source_doc = fsm_data.get("source_doc") or fsm_data.get("doc_type")
    # Resolve authority: FSM → DB users table → DOC_AUTHORITY_MAP fallback
    _db_row_7d = get_user(str(user_id)) or {}
    authority_for_meta = (
        fsm_data.get("authority_type")
        or fsm_data.get("termin_authority_type")
        or _db_row_7d.get("authority") or ""
        or DOC_AUTHORITY_MAP.get(source_doc or "", "buergeramt")
    )
    ...
    try:
        ...
        # Idempotency: reuse existing pending checkout if within TTL
        _idem_order_7 = _find_reusable_termin_order(user_id, "termin_monitor_7day")
        if _idem_order_7 and _idem_order_7.get("stripe_session_id"):
            _idem_oid_7 = _idem_order_7.get("id") or _idem_order_7.get("order_id")
            _idem_url_7 = _termin_checkout_sent.get(_idem_oid_7, "")
            if not _idem_url_7:
                try:
                    from backend.termin_db import get_entitlement_checkout_url as _gecu_7d
                    _idem_url_7 = _gecu_7d(str(user_id))
                except Exception:
                    pass
            if _idem_url_7 and _idem_url_7.startswith("https://"):
                logger.info("CHECKOUT_REUSED_7DAY | user=%s order=%s", user_id, _idem_oid_7)
                _idem_kb_7 = InlineKeyboardMarkup(row_width=1)
                _idem_kb_7.add(InlineKeyboardButton(
                    _lang_text(_STRIPE_OPEN_BTN, lang).format(price=f"{price:.2f}"),
                    url=_idem_url_7,
                ))
                await callback.message.answer(
                    _lang_text(_STRIPE_REDIRECT_TEXT, lang),
                    reply_markup=_idem_kb_7,
                    disable_web_page_preview=True,
                )
                return
        ...
        stripe = get_stripe_handler()
        from utils.user_email import get_user_email as _get_ue5
        _email = _get_ue5(user_id)
        logger.info(
            "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=7day",
            user_id, city_code, authority_for_meta, _email or "—",
        )
        result = await stripe.create_checkout_session(
            order_id=order_id,
        ...
        if result.success:
            ...
            db.update_order_status(order_id, OrderStatus.PENDING, stripe_session_id=result.session_id)
            logger.info(
                "STRIPE_CHECKOUT_CREATED | user_id=%s order_id=%s plan=7day city=%s authority=%s success_url=%s",
                user_id, order_id, city_code, authority_for_meta, success_url,
            )
            logger.info(
            ...
            try:
                from backend.termin_db import save_entitlement_checkout_url as _secu4
                _secu4(str(user_id), result.checkout_url)
            except Exception as _secu4_err:
                logger.debug("save_entitlement_checkout_url failed (non-fatal): %s", _secu4_err)
...
async def handle_termin_monitor_confirm_30day(callback: types.CallbackQuery, state: FSMContext):
    """Create Stripe Checkout for 30-day Extended monitoring plan (€19.99)."""
    await callback.answer(cache_time=1)
    city_code = callback.data.replace("termin_monitor_confirm_30day_", "")
    user_id = callback.from_user.id
    lang = _resolve_lang(user_id)

    logger.info("TERMIN_30DAY_CONFIRM | user=%s city=%s lang=%s", user_id, city_code, lang)

    fsm_data = await state.get_data()
    source_doc = fsm_data.get("source_doc") or fsm_data.get("doc_type")
    # Resolve authority: FSM → DB users table → DOC_AUTHORITY_MAP fallback
    _db_row_30d = get_user(str(user_id)) or {}
    authority_for_meta = (
        fsm_data.get("authority_type")
        or fsm_data.get("termin_authority_type")
        or _db_row_30d.get("authority") or ""
        or DOC_AUTHORITY_MAP.get(source_doc or "", "buergeramt")
    )
    price = _TERMIN_30DAY_PRICE

    logger.info(
        "TERMIN_30DAY_WEBHOOK_METADATA_PREPARED | user=%s city=%s authority=%s source_doc=%s",
        user_id, city_code, authority_for_meta, source_doc,
    )
    ...
    try:
        ...
        # Idempotency: reuse existing pending checkout if within TTL
        _idem_order_30 = _find_reusable_termin_order(user_id, "termin_monitor_30day")
        if _idem_order_30 and _idem_order_30.get("stripe_session_id"):
            _idem_oid_30 = _idem_order_30.get("id") or _idem_order_30.get("order_id")
            _idem_url_30 = _termin_checkout_sent.get(_idem_oid_30, "")
            if not _idem_url_30:
                try:
                    from backend.termin_db import get_entitlement_checkout_url as _gecu_30d
                    _idem_url_30 = _gecu_30d(str(user_id))
                except Exception:
                    pass
            if _idem_url_30 and _idem_url_30.startswith("https://"):
                logger.info("CHECKOUT_REUSED_30DAY | user=%s order=%s", user_id, _idem_oid_30)
                _idem_kb_30 = InlineKeyboardMarkup(row_width=1)
                _idem_kb_30.add(InlineKeyboardButton(
                    _lang_text(_STRIPE_OPEN_BTN, lang).format(price=f"{price:.2f}"),
                    url=_idem_url_30,
                ))
                await callback.message.answer(
                    _lang_text(_STRIPE_REDIRECT_TEXT, lang),
                    reply_markup=_idem_kb_30,
                    disable_web_page_preview=True,
                )
                return
        ...
        order_id = db.create_order(
            user_id=user_id,
            doc_type="termin_monitor_30day",
            amount=price,
            lang=order_lang,
        )
        logger.info(
            "TERMIN_ANALYTICS | event=order_created plan=30day city=%s authority=%s lang=%s source_doc=%s order_id=%s user_id=%s",
            city_code, authority_for_meta, lang, source_doc or "", order_id, user_id,
        )
        ...
        stripe = get_stripe_handler()
        from utils.user_email import get_user_email as _get_ue_30d
        _email = _get_ue_30d(user_id)
        logger.info(
            "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=30day",
            user_id, city_code, authority_for_meta, _email or "—",
        )
        result = await stripe.create_checkout_session(
            order_id=order_id,
        ...
        if result.success:
            ...
            db.update_order_status(order_id, OrderStatus.PENDING, stripe_session_id=result.session_id)
            logger.info(
                "STRIPE_CHECKOUT_CREATED | user_id=%s order_id=%s plan=30day city=%s authority=%s success_url=%s",
                user_id, order_id, city_code, authority_for_meta, success_url,
            )
            logger.info(
                "TERMIN_ANALYTICS | event=checkout_created plan=30day city=%s authority=%s order_id=%s user_id=%s",
                city_code, authority_for_meta, order_id, user_id,
            )
            try:
                from backend.termin_db import save_entitlement_checkout_url as _secu5
                _secu5(str(user_id), result.checkout_url)
            except Exception as _secu5_err:
                logger.debug("save_entitlement_checkout_url failed (non-fatal): %s", _secu5_err)
        ...
        logger.error("TERMIN_30DAY_STRIPE_ERROR | user=%s error=%s", user_id, e)

    from handlers.nav import nav_home_text as _nav_home_30day_err
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(InlineKeyboardButton(
        get_text("btn_back", lang),
        callback_data="back_to_main_menu",
    ))
    keyboard.add(InlineKeyboardButton(_nav_home_30day_err(lang), callback_data="main_menu"))
    await callback.message.answer(
        _lang_text(_STRIPE_ERROR_TEXT, lang),
        reply_markup=keyboard,
    )
...
async def handle_termin_monitor_family(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        stripe = get_stripe_handler()
        from utils.user_email import get_user_email as _get_ue6
        _email = _get_ue6(user_id)
        logger.info(
            "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=family",
            user_id, city_code, _fam_authority, _email or "—",
        )
        result = await stripe.create_checkout_session(
            order_id=order_id,
            user_id=user_id,
        ...
        if result.success:
            ...
            db.update_order_status(order_id, OrderStatus.PENDING, stripe_session_id=result.session_id)
            logger.info(
                "STRIPE_CHECKOUT_CREATED | user_id=%s order_id=%s plan=family city=%s authority=%s success_url=%s",
                user_id, order_id, city_code, _fam_authority, success_url,
            )
...
async def _activate_termin_family(
    ...
    try:
        ...
        _family_city = _family_user.get("city") or ""
        _family_auth = _family_user.get("authority") or "buergeramt"
        if not _family_city:
            logger.error(
                "CITY_MISSING_IN_DB | user=%s — family activation: city absent from termin users table",
                user_id,
            )
...
_SSTAT_LASTCHK_STARTING = {
    "uk": "щойно",
    "en": "just now", "de": "gerade eben",
    "pl": "teraz",    "tr": "şimdi",  "ar": "الآن",
}
_SSTAT_LASTCHK_MIN_AGO = {
    "uk": "~{n} хв тому",
    "en": "~{n} min ago",    "de": "vor ~{n} Min.",
    "pl": "~{n} min temu",   "tr": "~{n} dk önce",   "ar": "منذ ~{n} دق",
}
_SSTAT_LASTCHK_FEW_MIN = {
    "uk": "кілька хв тому",
    "en": "a few min ago",   "de": "vor einigen Min.",
    "pl": "kilka min temu",  "tr": "birkaç dk önce", "ar": "منذ بضع دقائق",
}
_SSTAT_EXPECTATION = {
...
_STATUS_EXPIRED_LBL = {
    "ua": "⛔ Моніторинг завершено",
    "uk": "⛔ Моніторинг завершено",
    "en": "⛔ Monitoring ended",
    "de": "⛔ Überwachung beendet",
    "pl": "⛔ Monitoring zakończony",
    "tr": "⛔ İzleme sona erdi",
    "ar": "⛔ انتهت المراقبة",
}
...
async def handle_termin_status(callback: types.CallbackQuery, state: FSMContext):
    ...
    # ── Auto-recovery: restart polling from DB when no in-memory session exists ──
    # Handles bot restart, cooldown-blocked start, or any other case where
    # the in-memory session was lost but the DB entitlement is still valid.
    if _live_session is None:
        try:
            from backend.termin_db import is_termin_active as _ita_rec, get_entitlement as _get_ent_rec
            if _ita_rec(str(user_id)):
                # Source of truth priority:
                # 1. termin_entitlements.city — immutable, written at payment time
                # 2. users.city — mutable UI state, fallback only
                _ent_rec = _get_ent_rec(str(user_id))
                _db_u_rec = _ensure_termin_user(user_id, lang)
                _rec_city = (
                    (_ent_rec or {}).get("city")
                    or (_db_u_rec or {}).get("city", "")
                )
                _rec_auth = (
                    (_ent_rec or {}).get("authority")
                    or (_db_u_rec or {}).get("authority", "")
                )
                _rec_source = "entitlement" if (_ent_rec and _ent_rec.get("city")) else "users"
                logger.info(
                    "AUTO_RECOVERY_SOURCE | user=%s city=%s source=%s",
                    user_id, _rec_city, _rec_source,
                )
                if _rec_city and _rec_auth:
                    from utils.termin_checker import (
                        start_polling as _stp_rec,
                        _cooldowns as _cd_rec,
                    )
                    _cd_rec.pop(user_id, None)  # clear any leftover cooldown so start is not blocked
                    _started_rec = _stp_rec(
                        user_id=user_id,
                        chat_id=user_id,
                        city=_rec_city,
                        authority=_rec_auth,
                        lang=lang,
                        send_fn=make_termin_send_fn(callback.bot, user_id, _rec_city, lang),
                        on_reserved_fn=make_termin_on_reserved_fn(
                            callback.bot, user_id, _rec_city, _rec_auth, lang, state=state
                        ),
                        on_found_fn=make_termin_found_fn(callback.bot, authority=_rec_auth),
                    )
                    if _started_rec:
                        _live_session = get_polling_session(user_id)
                        # User is already in the bot viewing Status — the activation
                        # screen was already delivered.  Lift the success barrier so
                        # slot notifications can fire immediately on next AVAILABLE.
                        from utils.termin_checker import set_success_screen_shown as _sss_rec
                        _sss_rec(user_id, True)
                        logger.info(
                            "TERMIN_SESSION_AUTO_RECOVERED | user=%s city=%s auth=%s source=%s",
                            user_id, _rec_city, _rec_auth, _rec_source,
                        )
                        print(f"TERMIN_SESSION_AUTO_RECOVERED user={user_id} city={_rec_city} auth={_rec_auth} source={_rec_source}", flush=True)
        except Exception as _rec_err:
            logger.warning("TERMIN_SESSION_RECOVER_FAILED | user=%s err=%s", user_id, _rec_err)
    ...
    if _live_session is not None:
        ...
        # Check expiry: calculate fresh from paid_until vs current UTC time.
        from utils.time_utils import format_remaining_time as _fmt_rt_live
        _is_expired_live = bool(_paid_until_stat) and _fmt_rt_live(_paid_until_stat) == "expired"
        _expired_override_live = _lang_text(_STATUS_EXPIRED_LBL, lang) if _is_expired_live else None

        # Single call builds the full live status text — no duplication.
        _s_city = _live_session.city or ""  # used for keyboard callback_data; empty means city not set
        _live_text = _build_status_text(
            _live_session, lang,
            countdown_line=_cd_stat,
            status_label_override=_expired_override_live,
        )
        ...
        # Row 3: refresh (recalculates remaining time on tap)
        _live_kb.add(InlineKeyboardButton(_lang_text(_STATUS_REFRESH_BTN, lang), callback_data="termin_refresh_status"))
        # Row 4: home | stop
        _live_kb.row(
            InlineKeyboardButton(_lang_text(_STATUS_HOME_BTN, lang), callback_data="main_menu"),
            InlineKeyboardButton(_lang_text(_STATUS_STOP_BTN, lang), callback_data="termin_stop_poll"),
        )
        try:
    ...
    city_code = data.get("termin_city") or ""
    city_code_resolved = _resolve_city_code(city_code) if city_code else ""
    ...
    if not started_iso and not is_paused:
        ...
        if is_termin_entitled(str(user_id)):
            ...
            if _db_city and _db_auth:
                ...
                # Check expiry fresh from paid_until vs current UTC time.
                from utils.time_utils import format_remaining_time as _fmt_rt_fb
                _is_expired_fb = bool(_paid_until_fb) and _fmt_rt_fb(_paid_until_fb) == "expired"
                _expired_override_fb = _lang_text(_STATUS_EXPIRED_LBL, lang) if _is_expired_fb else None
                ...
                _fb_text = _build_st_fb(
                    _stub_fb, lang,
                    countdown_line=_cd_fb,
                    status_label_override=_expired_override_fb,
                )
                ...
                # Refresh: recalculates remaining time on tap
                _fb_kb.add(InlineKeyboardButton(_lang_text(_STATUS_REFRESH_BTN, lang), callback_data="termin_refresh_status"))
                # Home | Stop
                _fb_kb.row(
                    InlineKeyboardButton(_lang_text(_STATUS_HOME_BTN, lang), callback_data="main_menu"),
                    InlineKeyboardButton(_lang_text(_STATUS_STOP_BTN, lang), callback_data="termin_stop_poll"),
    ...
    # Check expiry fresh from paid_until vs current UTC time.
    from utils.time_utils import format_remaining_time as _fmt_rt_fsm
    _is_expired_fsm = bool(_paid_until_fsm) and _fmt_rt_fsm(_paid_until_fsm) == "expired"
    ...
    # Expired takes priority over paused label; paused takes priority over active.
    if _is_expired_fsm:
        _fsm_status_override = _lang_text(_STATUS_EXPIRED_LBL, lang)
    elif is_paused:
        _fsm_status_override = status_label
    else:
        _fsm_status_override = None
    text = _build_st_fsm(
        _stub_fsm, lang,
    ...
    # Row 3: refresh (recalculates remaining time on tap)
    kb.add(InlineKeyboardButton(_lang_text(_STATUS_REFRESH_BTN, lang), callback_data="termin_refresh_status"))
    # Row 4: home | stop
    kb.row(
        InlineKeyboardButton(_lang_text(_STATUS_HOME_BTN, lang), callback_data="main_menu"),
        InlineKeyboardButton(_lang_text(_STATUS_STOP_BTN, lang), callback_data="termin_stop_poll"),
...
async def handle_termin_refresh_status(callback: types.CallbackQuery, state: FSMContext):
    """Refresh the monitoring status message with current remaining time.

    Recalculates remaining time fresh from paid_until vs current UTC time,
    then edits the same message (or sends a new one if edit fails).
    """
    await handle_termin_status(callback, state)
...
async def handle_termin_priority_pay(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        from utils.termin_checker import get_session as _get_sess7
        from utils.user_email import get_user_email as _get_ue7
        _sess7 = _get_sess7(user_id)
        _city7 = (_sess7.city if _sess7 else "") or ""
        _auth7 = (_sess7.authority if _sess7 else "") or ""
        _email = _get_ue7(user_id)
        ...
        stripe = get_stripe_handler()
        logger.info(
            "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=priority_boost",
            user_id, _city7, _auth7, _email or "—",
        )
        result = await stripe.create_checkout_session(
            order_id=order_id,
            user_id=user_id,
        ...
        if result.success:
            ...
            db.update_order_status(order_id, OrderStatus.PENDING, stripe_session_id=result.session_id)
            logger.info(
                "STRIPE_CHECKOUT_CREATED | user_id=%s order_id=%s plan=priority_boost city=%s authority=%s success_url=%s",
                user_id, order_id, _city7, _auth7, success_url,
            )
...
async def handle_termin_extend_pay(callback: types.CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        from utils.termin_checker import get_session as _get_sess8
        from utils.user_email import get_user_email as _get_ue8
        _sess8 = _get_sess8(user_id)
        _city8 = (_sess8.city if _sess8 else "") or ""
        _auth8 = (_sess8.authority if _sess8 else "") or ""
        _email = _get_ue8(user_id)
        ...
        stripe = get_stripe_handler()
        logger.info(
            "STRIPE_CREATE | user=%s city=%s authority=%s email=%s flow=extend_24h",
            user_id, _city8, _auth8, _email or "—",
        )
        result = await stripe.create_checkout_session(
            order_id=order_id,
            user_id=user_id,
        ...
        if result.success:
            ...
            db.update_order_status(order_id, OrderStatus.PENDING, stripe_session_id=result.session_id)
            logger.info(
                "STRIPE_CHECKOUT_CREATED | user_id=%s order_id=%s plan=extend_24h city=%s authority=%s success_url=%s",
                user_id, order_id, _city8, _auth8, success_url,
            )
        ...
        if text.startswith("\u23f3"):  # ⏳ reservation expired signal (U+23F3 hourglass)
            ...
            try:
                ...
                _resume_kb.add(InlineKeyboardButton(
                    _lang_text(_MONITOR_STATUS_BTN, _l),
                    callback_data="termin_status",
                ))
                _resume_kb.add(InlineKeyboardButton(
...
_BAD_URL_PARTS = ("ajax", "api", "json", "xhr")
...
# All URLs point to the actual booking/appointment system, not a generic info page.
_CITY_BOOKING_PORTALS: dict = {
    "berlin":       "https://service.berlin.de/terminvereinbarung/",
    "muenchen":     "https://www48.muenchen.de/buergeransicht/",   # actual booking portal
    ...
    "koeln":        "https://tevis.krzn.de/tevisweb190/",          # actual TeVIS booking
    "köln":         "https://tevis.krzn.de/tevisweb190/",
    "frankfurt":    "https://tevis.ekom21.de/fra/",                 # actual TeVIS booking
    "duesseldorf":  "https://termine.duesseldorf.de/",             # actual booking portal
    "düsseldorf":   "https://termine.duesseldorf.de/",
    "dortmund":     "https://dortmund.termine-reservieren.de/",
    "krefeld":      "https://tevis.krzn.de/tevisweb350/",          # actual TeVIS booking
}
...
_TERMIN_EMAIL_KILL_SWITCH_NOTE = {
    ...
    "en": "📧 Email alerts are off — this chat is your notification channel.",
    "de": "📧 E-Mail-Benachrichtigungen sind aus — nur dieser Chat.",
    "pl": "📧 E-mail wyłączony — tylko ten czat.",
    "tr": "📧 E-posta kapalı — yalnızca bu sohbet.",
    "ar": "📧 تنبيهات البريد معطّلة — هذا المحادثة فقط.",
}
...
async def _send_termin_slot_email(
    ...
    try:
        ...
        if not _settings.email.ENABLED:
            logger.info(
                "TERMIN_EMAIL_KILL_SWITCH_OFF: user=%s — EMAIL_ENABLED=0 "
                "(slot alert was already sent via Telegram)",
                user_id,
            )
            _lk = "uk" if lang in ("ua", "uk") else lang
            if _lk not in _TERMIN_EMAIL_KILL_SWITCH_NOTE:
                _lk = "en"
            if notify_bot is not None:
                try:
                    await notify_bot.send_message(
                        user_id,
                        _TERMIN_EMAIL_KILL_SWITCH_NOTE.get(_lk, _TERMIN_EMAIL_KILL_SWITCH_NOTE["en"]),
                    )
                except Exception as _n_err:
                    logger.debug("TERMIN_KILL_SWITCH_NOTIFY_FAILED: %s", _n_err)
            return
        ...
        logger.info(
            "TERMIN_EMAIL_TRIGGER | user=%s email=%s city=%s service=%s",
            user_id, to_email, _city_val, _service_val,
        )
        ...
        if ok:
            ...
            logger.warning(
                "TERMIN_EMAIL_FAILED: user=%s to=%s city=%s — scheduling 60s retry",
                user_id, to_email, _city_val,
            )
            # ── One-shot 60-second retry ────────────────────────────────────
            # Captures all needed values in closure so the retry is self-contained.
            async def _email_retry(
                _uid=user_id, _to=to_email, _city=_city_val, _svc=_service_val,
                _date=_date_val, _time=_time_val, _url=_url_val, _fb=_fallback_val,
                _lng=lang, _send=_send_email, _mark=_mark_notified,
                _is_notified=_is_notified,
            ):
                import asyncio as _aio
                await _aio.sleep(60)
                # Abort if email was already sent by another path in the meantime
                if _is_notified(str(_uid)):
                    return
                logger.info("TERMIN_EMAIL_RETRY | user=%s to=%s", _uid, _to)
                _ok2 = await _send(
                    to_email=_to, city=_city, service=_svc,
                    date=_date, time=_time, booking_url=_url,
                    fallback_url=_fb, lang=_lng,
                )
                if _ok2:
                    _mark(str(_uid))
                    logger.info("TERMIN_EMAIL_RETRY_SENT | user=%s to=%s", _uid, _to)
                else:
                    logger.warning("TERMIN_EMAIL_RETRY_FAILED | user=%s to=%s", _uid, _to)

            import asyncio as _aio_sched
            _aio_sched.ensure_future(_email_retry())
            # ────────────────────────────────────────────────────────────────
...
def make_termin_on_reserved_fn(
    ...
    async def _on_reserved(cid: int, rlang: str) -> None:
        ...
        _is_liveness2 = _slot.get("liveness_only", False)
        if _is_liveness2:
            from utils.termin_checker import _MSG_FOUND_LIVENESS as _MFL2
            _success_header = (
                f"{_lang_text(_MFL2, rlang)}\n\n"
                f"🏛 {_auth_display}\n"
                f"📍 {_city_display}"
            )
        else:
        ...
        try:
            from backend.termin_db import get_last_slot_found_at as _glsfa_db2
            _last_notified2 = _glsfa_db2(str(cid))
            if _last_notified2:
                _ln_dt2 = datetime.fromisoformat(_last_notified2)
                if _ln_dt2.tzinfo is None:
        ...
        try:
            ...
            _slsfa2(str(cid))
        except Exception as _slsfa2_err:
            logger.debug("set_last_slot_found_at failed (non-fatal): %s", _slsfa2_err)
...
# Shown instead of _RESUME_SEARCH_BTN when monitoring is already active
# (e.g. after "slot expired" message — polling resumed automatically).
_MONITOR_STATUS_BTN = {
    "ua": "🔍 Статус моніторингу",
...
def make_termin_found_fn(bot_instance, authority: str = ""):
    ...
    Sends the slot-found message with buttons:
      ...
      • "🔍 Monitoring status" — shows live monitoring screen
    ...
    async def _on_slot_found(cid: int, flang: str, slot: dict) -> None:
        ...
        # authority (closure) enables step E: authority-specific deep link.
        _city_hint = (slot.get("city") or slot.get("location") or "").lower()
        _auth_key = (authority or "").lower().strip()
        _links = _build_links(_city_hint, _auth_key, slot)
        _primary_url  = _links["primary"]
        _fallback_url = _links["fallback"]
        if slot.get("direct_url"):
            _url_src = "direct_url"
        elif slot.get("url"):
            _url_src = "slot_url"
        elif _auth_key and _city_hint:
            _url_src = "authority_deep_link"
        else:
            _url_src = "portal_fallback"
        logger.info(
            "BOOKING_URL_SOURCE | user=%s city=%s authority=%s url=%s source=%s",
            cid, _city_hint or "unknown", _auth_key or "—", _primary_url, _url_src,
        )
        ...
        kb.add(InlineKeyboardButton(
            _lang_text(_MONITOR_STATUS_BTN, flang),
            callback_data="termin_status",
        ))
        ...
        _dyn_portal3 = _get_portal_type(_city_hint)
        found_msg += "\n\n" + _build_dynamic_instructions(_dyn_portal3, _auth_key, flang)
        logger.info("TELEGRAM_ALERT_SOUND_ON | user=%s city=%s type=found portal=%s auth=%s", cid, _city_hint or "—", _dyn_portal3, _auth_key)
        logger.info(
            "BOOKING_CTA_DEBUG | user=%s city=%s document=%s url=%s source=make_termin_found_fn/_on_slot_found",
            cid, _city_hint or "—", _auth_key or "—", _primary_url,
        )
        await bot_instance.send_message(cid, found_msg, reply_markup=kb, disable_notification=False)
        logger.info("TELEGRAM_SENT | user=%s city=%s", cid, _city_hint or "—")

        # ── Email backup notification ─────────────────────────────────────────
        logger.info("EMAIL_TASK_QUEUED | user=%s city=%s", cid, _city_hint or "—")
        asyncio.create_task(
            _send_termin_slot_email(
                user_id=cid,
                city=_city_hint,
...
def register_termin_handlers(dp: Dispatcher):
    ...
    # MUST be first: termin_from_pdf (LTV) + retention_termin_from_pdf (10m retention)
    dp.register_callback_query_handler(
        handle_termin_from_pdf,
        lambda c: c.data in ("termin_from_pdf", RETENTION_TERMIN_CB),
        state="*",
    )
    dp.register_callback_query_handler(
    ...
    dp.register_callback_query_handler(
        handle_termin_refresh_status,
        lambda c: c.data == 'termin_refresh_status',
        state='*',
    )
    dp.register_callback_query_handler(
    ...
    dp.register_callback_query_handler(
        ...
        lambda c: c.data in ('termin_extend', 'termin_extend_24h'),
        state='*',
    )
    dp.register_callback_query_handler(
    ...
    dp.register_callback_query_handler(
        handle_termin_monitor_confirm_30day,
        lambda c: c.data and c.data.startswith('termin_monitor_confirm_30day_'),
        state='*',
    )
    dp.register_callback_query_handler(
    ...
    dp.register_callback_query_handler(
        ...
        lambda c: c.data and c.data.startswith('termin_monitor_confirm_')
            and not c.data.startswith('termin_monitor_confirm_7day_')
            and not c.data.startswith('termin_monitor_confirm_30day_'),
        state='*',
    )
    dp.register_callback_query_handler(
        handle_termin_menu,
    ...
    dp.register_callback_query_handler(
        handle_change_city_confirm,
        lambda c: c.data == 'termin_change_city_confirm',
        state='*',
    )
    dp.register_callback_query_handler(
        handle_change_city_cancel,
        lambda c: c.data == 'termin_change_city_cancel',
        state='*',
    )
    dp.register_callback_query_handler(
        handle_cities,
